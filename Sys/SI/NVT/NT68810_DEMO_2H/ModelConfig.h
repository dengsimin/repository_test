...
/*******************************************************************************
                              Define Board/Keypad
*******************************************************************************/
#define BOARD_TYPE                 NT68810_DEMO_BOARD_2H
#define KEYPAD_TYPE                NT68810_DEMO_KEYPAD

/*******************************************************************************
                              Model Feature On/Off
*******************************************************************************/
// Scaler
#define MD_SCALER_TYPE             NT68810

//UART Output Selection
#define MD_MCU_UART_OUTPUT         0 //TX/RX

//MCU Configuration
#define MD_MCU_CLK_TIMES           6 // 4 //MCU CLOCK = MCU_CLK_TIMES * REF_CLK
...
#define MD_INPUT_INTERFACE			(INPUT_VGA0|INPUT_DIG0|INPUT_DP|INPUT_DP1)//|INPUT_MHL0)  

#define MODEL_INPUT_VGA0        INPUT_SC_VGA
#define MODEL_INPUT_VGA1        INPUT_SC_NULL
#define MODEL_INPUT_DIG0        INPUT_SC_DVI//INPUT_SC_HDMI1
#define MODEL_INPUT_DIG1        INPUT_SC_NULL//INPUT_SC_HDMI2
#define MODEL_INPUT_DIG2        INPUT_SC_DP1  // DP
#define MODEL_INPUT_DIG3        INPUT_SC_DP     // DP
...
#define MD_ENABLE_DIGI0_HPD        OFF //ON/OFF
#define MD_ENABLE_DP_HPD           ON//ON //ON/OFF
#define MD_ENABLE_DP_ADV_HPD       ON//ON //ON/OFF
...
#define MD_ENABLE_INTERNAL_LDO     ON //ON/OFF
#define MD_ENABLE_INTERNAL_ADC_LDO ON //ON/OFF
...
#define MD_ENABLE_SCALER_LEDDRV_ANA_MODE  OFF //ON/OFF
#define MD_ENABLE_SCALER_LEDDRV    OFF //ON/OFF  
#define MD_ENABLE_SCALER_LEDDRV_IO_MODE OFF //ON/OFF  
