...
/*******************************************************************************
                              Define Board/Keypad
*******************************************************************************/
#define BOARD_TYPE                 NT68860_MODULE_BOARD
#define KEYPAD_TYPE                NT68860_MODULE_KEYPAD
...
#define MD_INPUT_INTERFACE         (INPUT_VGA0|INPUT_DIG2|INPUT_DIG3|INPUT_DP|INPUT_MHL2)//|INPUT_MHL0|INPUT_DP)
...
#define MD_ENABLE_MMU_DDR          OFF //ON/OFF
...
#define MD_ENABLE_AUTOFRAMEDOWN    ON
