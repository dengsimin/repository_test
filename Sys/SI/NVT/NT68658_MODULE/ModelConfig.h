...
/*******************************************************************************
                              Define Board/Keypad
*******************************************************************************/
#define BOARD_TYPE                 NT68658_MODULE_BOARD
#define KEYPAD_TYPE                NT68658_MODULE_KEYPAD

/*******************************************************************************
                              Model Feature On/Off
*******************************************************************************/
// Scaler
#define MD_SCALER_TYPE             NT68658
...
#define MD_MCU_UART_BAUD_RATE      1200 //Bit per second

//Input source type multi-selection
// INPUT_VGA0, INPUT_VGA1, INPUT_DIG0, INPUT_DIG1, INPUT_YPbPr0, INPUT_YPbPr1
#define MD_INPUT_INTERFACE         (INPUT_VGA0|INPUT_DIG0|INPUT_YPbPr0)
...
#define MIN_H_FREQ              150 // 271 //0.1KHz
#define MAX_H_FREQ              947 //0.1KHz
#define MIN_V_FREQ              200 // 480 //0.1Hz
