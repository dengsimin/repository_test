...
/*******************************************************************************
                              Define Board/Keypad
*******************************************************************************/
#define BOARD_TYPE                 NT68364_MODULE_BOARD
#define KEYPAD_TYPE                NT68364_MODULE_KEYPAD

/*******************************************************************************
                              Model Feature On/Off
*******************************************************************************/
// Scaler
#define MD_SCALER_TYPE             NT68364
...
#define MD_INPUT_INTERFACE         (INPUT_DIG0|INPUT_DIG1)
#define MODEL_INPUT_VGA0        INPUT_SC_NULL
#define MODEL_INPUT_VGA1        INPUT_SC_NULL
#define MODEL_INPUT_DIG0        INPUT_SC_HDMI1
...
#define MD_ENABLE_10TO10_GAMMA     ON //ON/OFF
#define MD_ENABLE_10TO12_GAMMA     OFF //ON/OFF
#define MD_ENABLE_OD               ON //ON/OFF
#define MD_ENABLE_OD_TRANSFORM     ON //ON/OFF
#define MD_ENABLE_OD_MOTION_CHK    ON //ON/OFF
#define MD_ENABLE_OD_3D_MODE       OFF //ON/OFF
#define MD_ENABLE_SINGLE_DDR       ON //ON/OFF
#define MD_ENABLE_MMU              ON //ON/OFF
#define MD_ENABLE_FE2P             ON //ON/OFF
#define MD_ENABLE_DIRECT_FE2P      OFF //ON/OFF 
#define MD_ENABLE_DVI_DUAL_LINK    OFF //ON/OFF
#define MD_ENABLE_HDMI             ON //ON/OFF
#define MD_ENABLE_HDMI_PRETEST     OFF //ON/OFF
#define MD_ENABLE_HDMI_FS_MUTE     OFF //ON/OFF
...
#define MD_ENABLE_3D_CNV           OFF //ON/OFF
#define MD_ENABLE_3D_CNV_120Hz     OFF //ON/OFF
#define MD_ENABLE_SHUTTER_3D       OFF //ON/OFF
#define MD_ENABLE_STRESS_TEST_KEY  OFF

#define MD_ENABLE_FUNC_OSD         ON //ON/OFF
...
//Version and Date
#define VERSION                 0x01
#define REVERSION               0x30
#define FIRMWARE_VER            (VERSION<<8 | REVERSION)
#define DATE                    "2011-07-18"
...
#define MAX_H_FREQ             1407 //0.1KHz
#define MIN_V_FREQ              200 //0.1Hz
#define MAX_V_FREQ             1300 //0.1Hz
...
#define SYNCSRC_TIME_ANALOG0    0000
#define SYNCSRC_TIME_DIGITAL0   3000
#define SYNCSRC_TIME_ANALOG1    0000
#define SYNCSRC_TIME_DIGITAL1   3000
