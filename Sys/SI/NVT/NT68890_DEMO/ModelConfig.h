...
/*******************************************************************************
                              Define Board/Keypad
*******************************************************************************/
#define BOARD_TYPE                 NT68890_DEMO_BOARD
#define KEYPAD_TYPE                NT68890_DEMO_KEYPAD
...
#define MD_INPUT_INTERFACE         (INPUT_VGA0|INPUT_DIG2|INPUT_DIG3|INPUT_DP|INPUT_DP1)//|INPUT_MHL0|INPUT_DP)
#define MODEL_INPUT_VGA0        INPUT_SC_VGA
#define MODEL_INPUT_VGA1        INPUT_SC_NULL
#define MODEL_INPUT_DIG0        INPUT_SC_NULL
#define MODEL_INPUT_DIG1        INPUT_SC_NULL
#define MODEL_INPUT_DIG2        INPUT_SC_DP
#define MODEL_INPUT_DIG3        INPUT_SC_DP1
...
#define MD_ENABLE_DIGI1_HPD        OFF//ON //ON/OFF
#define MD_ENABLE_DIGI2_HPD        ON //ON/OFF
#define MD_ENABLE_DIGI3_HPD        ON//ON //ON/OFF
#define MD_ENABLE_DP_HPD           OFF//OFF//ON //ON/OFF
#define MD_ENABLE_DP_ADV_HPD       OFF//OFF//ON //ON/OFF
#define MD_ENABLE_DP1_HPD          ON//ON //ON/OFF
#define MD_ENABLE_DP1_ADV_HPD      ON//ON //ON/OFF
...
#define MAX_H_FREQ             1947 //0.1KHz
#define MIN_V_FREQ              200 //0.1Hz
#define MAX_V_FREQ             1500 //0.1Hz
#define MAX_ANALONG_PIXEL_CLOCK 205 //MHz

/*******************************************************************************
                      Define Limitations for Out Of Limit
*******************************************************************************/
#define MIN_V_FREQ_LMT          200 //0.1Hz
#define MAX_V_FREQ_LMT         1500 //840 //0.1Hz
...
#define USBCC_HPD_LOW_PERIOD    250
