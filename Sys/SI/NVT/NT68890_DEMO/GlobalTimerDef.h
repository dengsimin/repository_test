...
#define GBTM_APPSYNC_STABLE    (SYNCSRC_TIME_ANALOG1+SYNCSRC_TIME_DIGITAL2+SYNCSRC_TIME_DIGITAL3+SYNCSRC_TIME_DP+SYNCSRC_TIME_DP1)
#define GBTM_NOSYNC_PWR_SAVING (GBTM_APPSYNC_STABLE+2000) //FPGA
...
#define GBTM_MHL_VBUS_TOGGLE   350   
