...
/*******************************************************************************
                              Define Board/Keypad
*******************************************************************************/
#define BOARD_TYPE                 NT68799_MODULE_BOARD
#define KEYPAD_TYPE                NT68790_MODULE_KEYPAD

/*******************************************************************************
                              Model Feature On/Off
*******************************************************************************/
// Scaler
#define MD_SCALER_TYPE             NT68799
...
#define MD_INPUT_INTERFACE         (INPUT_VGA0|INPUT_DIG0|INPUT_DP|INPUT_MHL0)
...
#define MD_ENABLE_DFR              ON //ON/OFF
...
#define SYNCSRC_TIME_ANALOG1    0
#define SYNCSRC_TIME_DIGITAL1   0 //HDMI=3000; DVI=1000
...
#if (HPD_LOW_PERIOD > SYNCSRC_TIME_DIGITAL0) && MD_ENABLE_DIGI0_HPD
#error "HPD_LOW_PERIOD is over SYNCSRC_TIME_DIGITAL0"
#endif
#if (HPD_LOW_PERIOD > SYNCSRC_TIME_DIGITAL1) && MD_ENABLE_DIGI1_HPD
