...
*******************************************************************************/
//Scaler selection
#define SCALER_TEXT             "NT68785"

//Input source type multi-selection
// INPUT_VGA0, INPUT_VGA1, INPUT_DIG0, INPUT_DIG1, INPUT_YPbPr0, INPUT_YPbPr1
#define INPUT_INTERFACE         (INPUT_VGA0|INPUT_YPbPr0|INPUT_DIG0|INPUT_DIG1|INPUT_MHL0|INPUT_MHL1)
...
//LOCAL DIMMING
#define ENABLE_LD               ON //ON/OFF Only NT68750 can define ON
...
//FRC
#define ENABLE_PREFRC				ON //ON/OFF
//DFR
