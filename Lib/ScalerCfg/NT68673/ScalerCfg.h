...
#define ENABLE_NEW_MCU_IO       OFF //ON/OFF
//LOW POWER MODE
#define ENABLE_LOW_PWR_MODE     OFF //ON/OFF
//System 5V check
...
//PWM SMOOTH
#define ENABLE_PWM_SMOOTH       OFF //ON/OFF Must be defined as OFF over NT68671~5
//FLASH IDLE MODE
