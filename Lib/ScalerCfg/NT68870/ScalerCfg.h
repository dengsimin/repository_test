...
*******************************************************************************/
//Scaler selection
#define SCALER_TEXT             "NT68875"//"NT68870"

//Input source type multi-selection
// INPUT_VGA0, INPUT_VGA1, INPUT_DIG0, INPUT_DIG1, INPUT_YPbPr0, INPUT_YPbPr1
//#define INPUT_INTERFACE         (INPUT_VGA0|INPUT_YPbPr0|INPUT_DIG0|INPUT_DIG1|INPUT_DIG2|INPUT_DIG3|INPUT_MHL0|INPUT_MHL1|INPUT_MHL2|INPUT_MHL3|INPUT_DP|INPUT_DP1|INPUT_DP2|INPUT_DP3)
#define INPUT_INTERFACE       MD_INPUT_INTERFACE//  (INPUT_DIG1|INPUT_DIG2|INPUT_DIG3|INPUT_DP)

//DVI Sync/DE mode selection
//  DVI_HV_MODE or DVI_DE_MODE or DVI_HVDE_MODE
#define DVI_MODE                DVI_HVDE_MODE

#define ICP_NEW_DE_MODE         OFF//ON
#define NEW_OVS_MODE            ON//ON
/*******************************************************************************
...
//OD
#define ENABLE_OD               ON //ON/OFF
#define ENABLE_OD_TRANSFORM     ON //ON/OFF
#define ENABLE_OD_MOTION_CHK    ON //ON/OFF
...
//DVI
#define ENABLE_DVI_DUAL_LINK    ON //ON/OFF
//HDMI
...
#define ENABLE_DIGI2_HPD        ON //ON/OFF
#define ENABLE_DIGI3_HPD        ON //ON/OFF
#define ENABLE_DP_HPD           ON //ON/OFF
#define ENABLE_DP_ADV_HPD       ON //ON/OFF
#define ENABLE_DP1_HPD          ON //ON/OFF
#define ENABLE_DP1_ADV_HPD      ON //ON/OFF
#define ENABLE_DP2_HPD          ON //ON/OFF
#define ENABLE_DP2_ADV_HPD      ON //ON/OFF
#define ENABLE_DP3_HPD          ON //ON/OFF
#define ENABLE_DP3_ADV_HPD      ON //ON/OFF
...
//LED DRIVER
#define ENABLE_SCALER_LEDDRV    ON //ON/OFF Only NT68650 can define ON
#define ENABLE_SCALER_LEDDRV_ANA_MODE  ON //ON/OFF
#define ENABLE_SET_PWM_MAX_BUFFER      ON //ON/OFF
#define ENABLE_SCALER_LEDDRV_IO_MODE   ON //ON/OFF
//LOCAL DIMMING
...
//SSC
#define ENABLE_SCALER_NEW_SSC     ON //ON/OFF
//INTERNAL AUTOCOLOR
...
#endif
// 3D FORMAT INPUT
#define ENABLE_SCALER_3D        OFF //ON/OFF
//LVDS
#define ENABLE_TEN_BIT_LVDS     ON //ON/OFF
#define ENABLE_FOUR_PORT_LVDS   ON //ON/OFF
//FRC
#define ENABLE_PREFRC           OFF //ON/OFF
//DFR
#define ENABLE_DFR              ON //ON/OFF
//Auto frame down
#define ENABLE_AUTOFRAMEDOWN    ON
//POST FRC
#define ENABLE_POSTFRC          ON //ON/OFF
//AUTO CONTROL
#define ENABLE_AUTO_CONTROL     ON //ON/OFF

//USB TYPE C
#define ENABLE_USB_TYPE_C       ON //ON/OFF

#define DCR_SMOOTH_PWM          ON
