...
*******************************************************************************/
#define FE2P_SRAM_ADDR          0xA400 // Size 0x800
#define GP_SRAM_ADDR            0xA000 // Size 0x400
...
//HDMI
#define ENABLE_HDMI             OFF //ON/OFF
#define ENABLE_HDMI_PRETEST     OFF //ON/OFF
...
//HPD
#define ENABLE_DIGI1_HPD        OFF //ON/OFF
#define ENABLE_DIGI0_HPD        OFF //ON/OFF
//SCALER AUDIO CONTROL
#define ENABLE_SCALER_AUDIO     OFF //ON/OFF
#define ENABLE_INTERNAL_AUDIO_BUZZER OFF //ON/OFF Only HDMI can define it ON
//OSD
...
//ADC SERIAL RESISTER
#define ENABLE_INTERNAL_ADC_RES ON //ON/OFF
//SERIAL INTERRUPT
#define ENABLE_SERIAL_INT       ON //ON/OFF
//EMBEDDED CHECKSUM
#define ENABLE_EMBEDDED_CHECKSUM ON //ON/OFF
//SCALING
#define ENABLE_OVERSCAN         OFF //ON/OFF Only NT68676 can define ON
//LED DRIVER
...
#define ENABLE_HW_AUTOCOLOR     ON //ON/OFF
