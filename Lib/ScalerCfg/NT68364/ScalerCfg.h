...
#define ENABLE_10TO10_GAMMA     ON //ON/OFF
#define ENABLE_10TO12_GAMMA     ON //ON/OFF
//DDR
#define ENABLE_SINGLE_DDR       ON //ON/OFF
//OD
#define ENABLE_OD               ON //ON/OFF
#define ENABLE_OD_TRANSFORM     ON //ON/OFF
#define ENABLE_OD_MOTION_CHK    ON //ON/OFF
#define ENABLE_OD_3D_MODE       OFF //ON/OFF
//MMU
#define ENABLE_MMU              ON //ON/OFF
#define ENABLE_MMU_ERR_RCVY     ON //ON/OFF
//FE2P
...
//DVI
#define ENABLE_DVI_DUAL_LINK    OFF //ON/OFF
//HDMI
#define ENABLE_HDMI             ON //ON/OFF
#define ENABLE_HDMI_PRETEST     ON //ON/OFF
#define ENABLE_HDMI_AUDIO_CK_RCVY OFF //ON/OFF
#define ENABLE_HDMI_AUDIO_AUTO_MUTE ON //ON/OFF
#define ENABLE_HDMI_FS_MUTE     ON
//CEC
#define ENABLE_HW_CEC           OFF //ON/OFF
//DBC
#define ENABLE_DBC              ON //ON/OFF
#define ENABLE_DBC_HW_DEBOUNCE  ON //ON/OFF
#define DBC_TABLE_GENERATION    1  //0 for NT68676 or older scalers
...
//FLASH IDLE MODE
#define ENABLE_FLASH_IDLE_MODE  ON //ON/OFF
//PANEL SPEC
#define ENABLE_FIT_ALL_PANEL_SPEC ON //ON/OFF
//3D
#define ENABLE_SCALER_3D        OFF //ON/OFF
#define ENABLE_3D_CNV           OFF //ON/OFF
#define ENABLE_3D_CNV_120Hz     OFF //ON/OFF
#define ENABLE_SHUTTER_3D       OFF //ON/OFF
//LVDS
