...
void ConfigScalerPWM(UCHAR port, UCHAR pin, ULONG freq)
{
    ...
    switch (pin) {
        case PWMA_PIN_66:
            SC_MCU_IO_CTRL4 &= ~(BIT7|BIT6);  // 0xc83
            SC_MCU_IO_CTRL4 |= BIT6;
            break;
        case PWMB_PIN_71:
            SC_MCU_IO_CTRL3 &= ~(BIT7|BIT6);// 0xc82
            SC_MCU_IO_CTRL3 |= BIT6;
            break;
        case PWMB_PIN_63:
            SC_MCU_IO_CTRL5 &= ~(BIT5|BIT4);// 0xc84
            SC_MCU_IO_CTRL5 |= BIT5;
            break;
        case PWMB_PIN_120:
            ...
            break;
        case PWMC_PIN_116:
            SC_MCU_IO_CTRL1 &= ~(BIT3|BIT2);// 0xc80
        ...
        case PWMC_PIN_123:
            ...
            break;
        case PWMD_PIN_59:
            SC_MCU_IO_CTRL5 &= ~(BIT7|BIT6);
            SC_MCU_IO_CTRL5 |= BIT6;
            break;
        case PWMA_PIN_PC0:
            SC_MCU_IO_CTRL5 &= ~(BIT7|BIT6);
            SC_MCU_IO_CTRL5 |= BIT6;
            break;
        case PWMA_PIN_PE0:
            SC_MCU_IO_CTRL8 &= ~(BIT7|BIT6);// 0xc87
            SC_MCU_IO_CTRL8 |= BIT6;
            break;
        case PWMB_PIN_PC6:
            SC_MCU_IO_CTRL0 &= ~(BIT4|BIT3|BIT2);// 0xc7f
            SC_MCU_IO_CTRL0 |= BIT3;
            break;
        case PWMB_PIN_PE1:
            SC_MCU_IO_CTRL8 &= ~(BIT5|BIT4);
            SC_MCU_IO_CTRL8 |= BIT4;
            break;
        case PWMC_PIN_PA3:
            SC_MCU_IO_CTRL2 &= ~(BIT1|BIT0);// 0xc81
        ...
        case PWMC_PIN_PA4:
            ...
            break;
        case PWMC_PIN_PC3:
            SC_MCU_IO_CTRL5 &= ~(BIT1|BIT0);
            SC_MCU_IO_CTRL5 |= BIT0;
            break;
        case PWMD_PIN_PC5:
            SC_MCU_IO_CTRL0 &= ~(BIT7|BIT6|BIT5);
            SC_MCU_IO_CTRL0 |= BIT6;
            break;
    }
