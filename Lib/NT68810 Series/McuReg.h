...
extern xdata UCHAR volatile DDC_CTL4;
extern xdata UCHAR volatile DDC_ADDR4;
//INTERRUPT SOURCE CONTROL REGISTER
extern xdata UCHAR volatile INT_SRC;
#if IS_NT68870_SERIES
    #define INT_TIMEAR      0x80
    #define INT_EXT         0x40
    #define INT_IIC4        0x20
    #define INT_IIC3        0x10
    #define INT_IIC2        0x08
    #define INT_IIC1        0x04
    #define INT_IIC0        0x02
    #define INT_SC          0x01
#else
...
#if IS_NT68870_SERIES
    #define INT_DPTX        0x80
    #define INT_HDMI        0x40
...
//USBCC INTERRUPT
extern xdata UCHAR volatile INT_USB_CC; // _at_ 0xF02E;
	#define INT_USBCC_EN    0x80
    #define INT1_USBCC       0x01   // Link layer 1 ,FPGA use only for ac as DFP
    #define INT0_USBCC       0x08   // Link layer 0 , NT68870 use this
...
extern xdata UCHAR volatile IIC4_CFG;
extern xdata UCHAR volatile IIC4_STATUS;
extern xdata UCHAR volatile IIC4_INT_EN;
extern xdata UCHAR volatile IIC4_INT_FLG;
extern xdata UCHAR volatile IIC4_INT_CLR;
extern xdata UCHAR volatile IIC4_TXDATA;
extern xdata UCHAR volatile IIC4_RXDATA;
extern xdata UCHAR volatile IIC4_ADDR;
...
extern xdata UCHAR volatile SPI_CE;
extern xdata UCHAR volatile SPI_CE_ADDR_HI;
extern xdata UCHAR volatile SPI_CE_ADDR_LO;
extern xdata UCHAR volatile SPI_W_ADDR_HI;
extern xdata UCHAR volatile SPI_W_ADDR_LO;
extern xdata UCHAR volatile SPI_R_ADDR_HI;
extern xdata UCHAR volatile SPI_R_ADDR_LO;
...
extern xdata UCHAR volatile DP_CTRL2;   // Yung Add for NT68870 use
//AO DETECT
...
extern xdata UCHAR volatile EDID_SRAM_BUFF4[256];
