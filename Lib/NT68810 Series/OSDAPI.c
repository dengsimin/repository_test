...
//******************************************************************************
xdata UCHAR ucOSDConfig = (OSD_POS_ROT_OFF << 2) | OSD_ALIGN_LEFT; /*!< Variable for OSD indent status and OSD rotation status. */
xdata USHRT usOSDWinRotStatus = 0x0000; /*!< Rotation status of each OSD window. */
