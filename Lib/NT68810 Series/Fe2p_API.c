...
#pragma endasm
    do {
        ...
        Addr = FE2P_SRAM_ADDR+3; *Addr = (UCHAR)(index1>>16);//0xA011 = 0x00        //write data 1 (addr [23:16])
        Addr = FE2P_SRAM_ADDR+4; *Addr = (UCHAR)(index1>>8);//0xA012 = 0x00        //write data 2 (addr [15:8]
