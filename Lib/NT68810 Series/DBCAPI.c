...
#else
            SC_MCU_IO_CTRL8 &= ~(BIT7|BIT6);
            SC_MCU_IO_CTRL8 |= BIT7;
#endif
            break;
            /*
        case DBC_PIN_PWM_2:
...
#if 0//!IS_NT68770_SERIES && !IS_NT68850_SERIES && !IS_NT68655_SERIES && !IS_NT68150_SERIES && !IS_NT68790_SERIES && !IS_NT68658_SERIES
/**************************************************************************//**
 * Get active PWM duty.
