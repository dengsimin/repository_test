...
/*                            All Rights Reserved                             */
/******************************************************************************/
#ifndef __SCALER_PROFILE_NT68870_H__
#define __SCALER_PROFILE_NT68870_H__  // feng-160830
...
#else
#define SCREG_025_A 0x00|BIT3
#define SCREG_038_A 0x00//0x10
#endif
#define SCREG_025_D 0x00//0x00
#define SCREG_038_D 0x00//0x00
...
#endif
#define SCREG_B41      0x83//0x07
#define SCREG_B42      0x00//(SC_MPLL_CTRL_B42 & ~BIT2)
#define SCREG_B43      0x3F//0x19
...
#if MD_ENABLE_MMU_DDR == ON
//******************************************************************************
// MMU Configure DDR
//******************************************************************************
//MMU_DRAMIF 
#define SCREG_580 0x49
#define SCREG_581 0x10
#define SCREG_582 0x33
#define SCREG_583 0x00
#define SCREG_584 0x00//0x01
#define SCREG_585 0x20
#define SCREG_586 0x00
#define SCREG_587 0x00
#define SCREG_588 0x00
#define SCREG_589 0x01
#define SCREG_58A 0x01
//MMU_DQSDelay
#define SCREG_5F0 0x00
#define SCREG_5F1 0x00
#define SCREG_5F2 0x00
#define SCREG_5F3 0x00
#define SCREG_5F4 0x22
#define SCREG_5F5 0x00
#define SCREG_5F6 0x08
#define SCREG_5F7 0x81
#define SCREG_5F8 0x00
#define SCREG_5F9 0x00
#define SCREG_5FA 0x00
//MMU_PLL
#define SCREG_B80 0x00
#define SCREG_B81 0x00
#define SCREG_B82 0x00
#define SCREG_B83 0x00
#define SCREG_B84 0xC3
#define SCREG_B85 0x71//0xA1
#define SCREG_B86 0x00
#define SCREG_B87 0x00
#define SCREG_B88 0x00
#define SCREG_B89 0x00
#define SCREG_B8A 0x00
#define SCREG_B8B 0x10
#define SCREG_B8C 0x17//0x18
#define SCREG_B8D 0x17//0x18
#define SCREG_B8E 0x13//0x14
#define SCREG_B8F 0x13//0x14
//MMU_PLLSKEW
#define SCREG_B90 0x00
#define SCREG_B91 0x00
#define SCREG_B92 0x12//0x16
#define SCREG_B93 0x16
//MMU_PLLFREQ
#define SCREG_B31 0xAA
#define SCREG_B32 0xAA
#define SCREG_B33 0x29
#define SCREG_B34 0x0D
...
#define SCREG_B8C 0x08
#define SCREG_B8D 0x08
#define SCREG_B8E 0x00
#define SCREG_B8F 0x00
//MMU_PLLSKEW
#define SCREG_B90 0x00
#define SCREG_B91 0x00
#define SCREG_B92 0x08
#define SCREG_B93 0x00
//MMU_PLLFREQ
#define SCREG_B31 0xAA
#define SCREG_B32 0xAA
#define SCREG_B33 0x1A
#define SCREG_B34 0x00
...
#endif //__SCALER_PROFILE_NT68870_H__
