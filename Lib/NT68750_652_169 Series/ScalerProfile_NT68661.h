...
/*                            All Rights Reserved                             */
/******************************************************************************/
#ifndef __SCALER_PROFILE_NT68661_H__
#define __SCALER_PROFILE_NT68661_H__
...
#define SCREB_B61_PD 0x01//0x07
#define SCREB_B62_PU 0x05
#define SCREB_B62_PD 0xFA
#define SCREB_B63_INT_LDO 0x02//0x04
...
#define SCREG_0D1 0x13//0x23

#define SCREG_025_A 0x40
#define SCREG_025_D 0x40
//SR
#define SCREG_EA0      0x30
...
// TMDS Related
#define SCREG_331      0x05//0x03
#define SCREG_333_PU   0x8F//0x9F//0x87
#define SCREG_333_PD   0x00
#define SCREG_333_LP0  0x07
#define SCREG_333_LP1  0x07
#define SCREG_334_PU   0x81//0xF1//0x01
#define SCREG_334_PD   0x00
#define SCREG_334_LF   (SC_DVI_CTRL_334 & ~BIT2)//(SC_DVI_CTRL_334 | BIT2)
...
#define LED_DRV_REG_TABLE { \
            0x00,0xFF,0xFF,0x46,0x2F,0x39,0x89,0x78,0xC0,0xF7,0xFC,0xCC,0x40,0x00,0x00,0x00, \
            0x0F,0x00,0x0D,0x00,0x00,0xFF,0x00,0xCC,0x00,0xC0,0x00,0xE5,0x2E,0x0F,0xFF,0xE0  \
        } /*!< Default LD setting for NT68652. */
...
#endif //__SCALER_PROFILE_NT68661_H__
