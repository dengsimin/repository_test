...
void ADCInit(void)
{
    ...
    SC_ADC_CTRL_OPTION2 = 0x04;//0xF8;
    SC_ADC_CTRL_OPTION3 = 0x90;//0xFC;
#elif IS_NT68169_SERIES
    SC_ADC_CTRL_OPTION1 = 0x00;//0x30;
...
#if IS_NT68169_SERIES// internal LDO only
    bw = ADC_BW_450MHz;
#endif    
    SC_ADC_BW_CTRL &= 0xF8;
...
void SetADCInput(ADCInput input)
{
    ...
    SC_ADC_INPUT_CTRL = (SC_ADC_INPUT_CTRL & 0xFC) | input;
}
