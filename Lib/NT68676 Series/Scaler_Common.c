...
void SetInputInterface(UCHAR interface)
{
    ...
    code UCHAR interface_data[][sizeof(interface_tab)/sizeof(UCHAR *)] = {
      //0x000,0x008,0x00A,0x00F,0x020,0x021,0x023,0x024,              0x025,0x026,0x196,0x012,0x072,0x1E6,0x336
        {0x10, 0x00, 0x80, 0x00, 0xA1, 0x81, 0x00, 0x80|HDMI_PIN_ORDR, 0x40, 0x00, 0x60, 0x00, 0x01, 0x01, 0x00}, //ANALOG_SEP_INPUT0
        {0x10, 0x00, 0x80, 0x00, 0xA1, 0x81, 0x00, 0x80|HDMI_PIN_ORDR, 0x40, 0x80, 0x61, 0x00, 0x00, 0x01, 0x00}, //ANALOG_COM_INPUT0
        {0x18, 0x00, 0x88, 0x00, 0xA1, 0x01, 0x40, 0x80|HDMI_PIN_ORDR, 0x40, 0x80, 0x61, 0x9A, 0x10, 0x51, 0x00}, //ANALOG_SOG_INPUT0
    #if DVI_MODE == DVI_HV_MODE
        {0x10, 0x00, 0x80, 0x00, 0x83, 0x01, 0x00, 0x82|HDMI_PIN_ORDR, 0x00, 0x00, 0x90, 0x00, 0x00, 0x01, 0xC0}, //DIGITAL_INPUT0
    #elif DVI_MODE == DVI_DE_MODE
        {0x10, 0x00, 0x80, 0x00, 0x83, 0x01, 0x00, 0x82|HDMI_PIN_ORDR, 0x00, 0x00, 0x20, 0x00, 0x00, 0x01, 0xC0}, //DIGITAL_INPUT0
    #elif DVI_MODE == DVI_HVDE_MODE 
        {0x10, 0x00, 0x80, 0x00, 0x83, 0x01, 0x08, 0x82|HDMI_PIN_ORDR, 0x00, 0x00, 0x90, 0x00, 0x00, 0x01, 0xC0}, //DIGITAL_INPUT0
    #endif
        {0x10, 0x00, 0x80, 0x00, 0xA1, 0x81, 0x00, 0x81|HDMI_PIN_ORDR, 0x40, 0x00, 0x60, 0x00, 0x01, 0x01, 0x00}, //ANALOG_SEP_INPUT1
        {0x10, 0x00, 0x80, 0x00, 0xA1, 0x81, 0x00, 0x81|HDMI_PIN_ORDR, 0x40, 0x80, 0x61, 0x00, 0x00, 0x01, 0x00}, //ANALOG_COM_INPUT1
        {0x18, 0x00, 0x88, 0x00, 0xA1, 0x01, 0x40, 0x81|HDMI_PIN_ORDR, 0x40, 0x80, 0x61, 0x9A, 0x10, 0x51, 0x00}, //ANALOG_SOG_INPUT1
    #if DVI_MODE == DVI_HV_MODE
        {0x10, 0x00, 0x80, 0x00, 0x83, 0x01, 0x00, 0x87|HDMI_PIN_ORDR, 0x00, 0x00, 0x90, 0x00, 0x00, 0x01, 0xC0}, //DIGITAL_INPUT1
    #elif DVI_MODE == DVI_DE_MODE
        {0x10, 0x00, 0x80, 0x00, 0x83, 0x01, 0x00, 0x87|HDMI_PIN_ORDR, 0x00, 0x00, 0x20, 0x00, 0x00, 0x01, 0xC0}, //DIGITAL_INPUT1
    #elif DVI_MODE == DVI_HVDE_MODE
        {0x10, 0x00, 0x80, 0x00, 0x83, 0x01, 0x08, 0x87|HDMI_PIN_ORDR, 0x00, 0x00, 0x90, 0x00, 0x00, 0x01, 0xC0}, //DIGITAL_INPUT1
    #endif
        {0x18, 0x03, 0x88, 0x00, 0xA1, 0x01, 0xC0, 0x80|HDMI_PIN_ORDR, 0x40, 0x80, 0x61, 0x9A, 0x10, 0x51, 0x00}, //ANALOG_YPBPR_INPUT0
        {0x18, 0x03, 0x88, 0x00, 0xA1, 0x01, 0xC0, 0x81|HDMI_PIN_ORDR, 0x40, 0x80, 0x61, 0x9A, 0x10, 0x51, 0x00}, //ANALOG_YPBPR_INPUT1
    };
