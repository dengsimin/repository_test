...
UCHAR CheckInputSync(void)
{
    ...
    switch (curr_interface) {
        ...
        case DIGITAL_INPUT1:
            //Check SCDT
#if ENABLE_LOW_PWR_MODE == OFF
           // SC_DVI_ZERO_POWER_CTRL = 0x00;    //detect current mode
           // SC_DVI1_ZERO_POWER_CTRL = 0x00;    //detect current mode
            DVI_PowerOn();
#endif
...
BOOL ZpVGA0SyncDetect(void)
{
    ...
    SC_INPUT_SELECT = 0x80|HDMI_PIN_ORDR;
    //SC_ADC_ZERO_POWER_CTRL = 0x89;    //enable CR R/W, SOG power
    SC_SOG_SLICER_CTRL = 0x82;    //SOG slicer en
    SC_ADC_REG_1D |= BIT6;
    ...
    SC_SOG_SLICER_CTRL = 0x81;    //SOG slicer dis
...
{
    SC_ADC_ZERO_POWER_CTRL = 0x89 | BIT1;    //enable CR R/W, SOG power
    SC_INPUT_SELECT = 0x81|HDMI_PIN_ORDR;
    //SC_ADC_ZERO_POWER_CTRL = 0x89;    //enable CR R/W, SOG power
    SC_SOG_SLICER_CTRL = 0x82;    //SOG slicer en
    SC_ADC_REG_1D |= BIT6;
    SC_SOG_SLICER_EN = 0x08;
...
BOOL ZpDVI0SyncDetect(void)
{
    ...
    SC_INPUT_SELECT = 0x82|HDMI_PIN_ORDR;
...
#if 1
    SC_ADC_ZERO_POWER_CTRL = 0x83;
    SC_INPUT_SELECT = 0x87|HDMI_PIN_ORDR;
