...
//******************************************************************************
#define OSD_RAM_SIZE     5120 /*!< Define scaler OSD sram size. The unit is 3-bytes. */
#define OSD_ROT_RAM_SIZE 5111 /*!< Define scaler OSD sram size when OSD rotation is enabled. The unit is 3-bytes. */
...
#define OSDAPI_GetOSDFrameSize(w,h) (((USHRT)w * h * 4 + 2) / 3) /*!< Get OSD frame size in OSD sram. Unit is 3-bytes. */
