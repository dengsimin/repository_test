...
extern xdata UCHAR volatile SC_OSD_ROW_INDEX;
...
extern xdata UCHAR volatile SC_OSD_ROW_ATTRIBUT_CTRL1;
extern xdata UCHAR volatile SC_OSD_BOARD_SHADOW_COLOR;
extern xdata UCHAR volatile SC_OSD_ROW_ATTRIBUT_CTRL2;
...
extern xdata UCHAR volatile SC_OSD_COMBINATION_FONT_ADDR_LO;
extern xdata UCHAR volatile SC_OSD_COMBINATION_FONT_ADDR_HI;
...
extern xdata UCHAR volatile SC_OSD_FRAME_VER_TOATL_LO;
extern xdata UCHAR volatile SC_OSD_FRAME_VER_TOATL_HI;
extern xdata UCHAR volatile SC_OSD_SPLIT_CTRL;
extern xdata UCHAR volatile SC_OSD_HOR_SPLIT_START_LO;
extern xdata UCHAR volatile SC_OSD_HOR_SPLIT_WIDTH_LO;
extern xdata UCHAR volatile SC_OSD_HOR_SPLIT_HI;
extern xdata UCHAR volatile SC_OSD_VER_SPLIT_START_LO;
extern xdata UCHAR volatile SC_OSD_VER_SPLIT_WIDTH_LO;
extern xdata UCHAR volatile SC_OSD_VER_SPLIT_HI;
extern xdata UCHAR volatile SC_OSD_ATTRIBUTE_HI;
...
extern xdata UCHAR volatile SC_DFR_GAMMA_CTRL;

extern xdata UCHAR volatile SC_DRAM_BASE_ADDR_DEI_LO;
extern xdata UCHAR volatile SC_DRAM_BASE_ADDR_DEI_MI;
extern xdata UCHAR volatile SC_DRAM_BASE_ADDR_DEI_HI;
extern xdata UCHAR volatile SC_DEI_MODE_CTRL;
extern xdata UCHAR volatile SC_FRAME_WIDTH_LO;
extern xdata UCHAR volatile SC_FRAME_WIDTH_HI;
extern xdata UCHAR volatile SC_FRAME_HIGHT_LO;
extern xdata UCHAR volatile SC_FRAME_HIGHT_HI;
extern xdata UCHAR volatile SC_IP_RW_WIDTH_LO;
extern xdata UCHAR volatile SC_IP_RW_WIDTH_HI;
extern xdata UCHAR volatile SC_IP_RW_HIGHT_LO;
extern xdata UCHAR volatile SC_IP_RW_HIGHT_HI;

extern xdata UCHAR volatile SC_FRAME_BUFFER_BASE_ADDR_FRC_LO;
extern xdata UCHAR volatile SC_FRAME_BUFFER_BASE_ADDR_FRC_MI;
extern xdata UCHAR volatile SC_FRAME_BUFFER_BASE_ADDR_FRC_HI;
...
extern xdata UCHAR volatile SC_PWM_SELECT;
extern xdata UCHAR volatile SC_PWMA_OUTPUT_CTRL;
    #define PD0_OUTPUT_EN       BIT1
    #define PC6_OUTPUT_EN       BIT0

extern xdata UCHAR volatile SC_PWMB_OUTPUT_CTRL;
    #define PD1_OUTPUT_EN       BIT2
    #define PC5_OUTPUT_EN       BIT1
    #define PC2_OUTPUT_EN       BIT0

extern xdata UCHAR volatile SC_INPUT_VIDEO_FORMAT;
extern xdata UCHAR volatile SC_COLOR_BURST_WIN_START;
extern xdata UCHAR volatile SC_COLOR_BURST_WIN_END;
extern xdata UCHAR volatile SC_CHROMA_LOCK;
extern xdata UCHAR volatile SC_VIDEO_SOFTWARE_RESET;
extern xdata UCHAR volatile SC_NON_COLOR_SYSTEM;
extern xdata UCHAR volatile SC_STATUS_REPORT[];
    #define CLOCK               BIT_3
    #define VLOCK               BIT_2
    #define HLOCK               BIT_1
    #define Ver625              BIT_2
extern xdata UCHAR volatile SC_AUTO_MODE_CTRL;
extern xdata UCHAR volatile SC_AMC_MASK;
extern xdata UCHAR volatile SC_AMC_COLOR_SYSTEM;
extern xdata UCHAR volatile SC_AMC_WAIT_TIME;
extern xdata UCHAR volatile SC_AMC_READY;

extern xdata UCHAR volatile SC_VIDEO_PATH_FILTER;
extern xdata UCHAR volatile SC_LUMA_GAIN;
extern xdata UCHAR volatile SC_LUMA_OFFSET;
extern xdata UCHAR volatile SC_CHROMA_SATURAATION;
extern xdata UCHAR volatile SC_CHROMA_HUE;
extern xdata UCHAR volatile SC_AFE_CTRL[];
extern xdata UCHAR volatile SC_TVADC0_GAIN_HI;
extern xdata UCHAR volatile SC_TVADC1_GAIN_HI;
extern xdata UCHAR volatile SC_TVADC2_GAIN_HI;
extern xdata UCHAR volatile SC_TVADC_GAIN_LO;
extern xdata UCHAR volatile SC_TVADC_OFFSET;
extern xdata UCHAR volatile SC_TVADC_OPAMP_CURRENT;
extern xdata UCHAR volatile SC_TVADC_INPUT_SOURCE;
extern xdata UCHAR volatile SC_TVADC_ADC_GAIN_CTRL;
extern xdata UCHAR volatile SC_TVADC_ADC_BANDWIDTH;
extern xdata UCHAR volatile SC_TVADC_ADC_CTRL;
extern xdata UCHAR volatile SC_TVADC_CURRENT_CTRL1;
extern xdata UCHAR volatile SC_TVADC_CURRENT_CTRL2;
extern xdata UCHAR volatile SC_CVD2_CLK_SELECT;
extern xdata UCHAR volatile SC_HVPLL_LOCK;
#endif
