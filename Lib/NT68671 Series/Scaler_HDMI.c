...
void HDMIInit(void)
{
    ...
    SC_AUDIO_VOLUME_R = 0x28;
    SC_AUDIO_VOLUME_L = 0x28;
    ScalerAudioPowerOn();
 ...
 * @param value The range is from 0x00 to 0x28.
 ******************************************************************************/
static void ConfigHDMIAnalogAudioGain(UCHAR value)
{
...
#define HDMI_AUDIO_VOLUME_RANGE    1023
    ...
    if (value > HDMI_AUDIO_VOLUME_RANGE) {
        value = HDMI_AUDIO_VOLUME_RANGE;
    }

    value = HDMI_AUDIO_VOLUME_RANGE - value;
    value = (ULONG)value * 0x28 / HDMI_AUDIO_VOLUME_RANGE;
