...
void TMDSInit(void)
{
    ...
    SC_DVI_CTRL_332 = 0xBF;
    SC_DVI_CTRL_334 = 0x00;
    DVI_PowerOn();
    SC_DVI_CTRL_337 = 0x87;
...
{
#define PIXEL_RATE_LOW    99
#define PIXEL_RATE_MID    101

    if (TMDS_GetClock() < PIXEL_RATE_LOW) {
        SC_DVI_CTRL_332 = 0x3F;
        SC_DVI_CTRL_334 = 0x04;
    #if IS_NT68674_SERIES
