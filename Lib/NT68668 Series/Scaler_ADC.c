...
void ADCInit(void)
{
    ...
    SC_ADC_BW_CTRL = 0x07;
    SC_ADC_CLAMP_CTRL = SCREG_00F_PU;
    SC_CLAMP_BEGIN = 0x0C;
    SC_CLAMP_WIDTH = 0x81;

    SC_SOG_CURRENT_CTRL = 0x80;
    SC_SOG_GLITCH_MASK_LO = 0x55;
    SC_SOG_DIGITAL_FILTER_CTRL = 0x00;
    SC_SOG_SLICER_CTRL = 0x7D;
...
void EnableADCGndSampling(UCHAR enable)
{
    ...
    SC_ADC_CTRL |= BIT0;// FOR APN SETTING
#endif
}
