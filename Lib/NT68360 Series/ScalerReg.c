...
xdata UCHAR volatile SC_DVI0_PIXELCLK_LO _at_ 0x833E;
xdata UCHAR volatile SC_DVI0_PIXELCLK_HI _at_ 0x833F;
...
xdata UCHAR volatile SC_MICRO_RETARDED_CTRL _at_ 0x8505;
xdata UCHAR volatile SC_3D_FORMAT_SEL _at_ 0x8506;
xdata UCHAR volatile SC_3D_FORMAT_CTRL _at_ 0x8507;
...
xdata UCHAR volatile SC_FRAME_BUFFER1R_BASE_ADDR_FRC_LO _at_ 0x850B;
xdata UCHAR volatile SC_FRAME_BUFFER1R_BASE_ADDR_FRC_MI _at_ 0x850C;
xdata UCHAR volatile SC_FRAME_BUFFER1R_BASE_ADDR_FRC_HI _at_ 0x850D;
...
xdata UCHAR volatile SC_FRAME_BUFFER2R_BASE_ADDR_FRC_LO _at_ 0x8511;
xdata UCHAR volatile SC_FRAME_BUFFER2R_BASE_ADDR_FRC_MI _at_ 0x8512;
xdata UCHAR volatile SC_FRAME_BUFFER2R_BASE_ADDR_FRC_HI _at_ 0x8513;
...
xdata UCHAR volatile SC_FRAME_BUFFER1L_BASE_ADDR_PREFRC_LO _at_ 0x8517;
xdata UCHAR volatile SC_FRAME_BUFFER1L_BASE_ADDR_PREFRC_MI _at_ 0x8518;
xdata UCHAR volatile SC_FRAME_BUFFER1L_BASE_ADDR_PREFRC_HI _at_ 0x8519;
xdata UCHAR volatile SC_FRAME_BUFFER1R_BASE_ADDR_PREFRC_LO _at_ 0x851A;
xdata UCHAR volatile SC_FRAME_BUFFER1R_BASE_ADDR_PREFRC_MI _at_ 0x851B;
xdata UCHAR volatile SC_FRAME_BUFFER1R_BASE_ADDR_PREFRC_HI _at_ 0x851C;

xdata UCHAR volatile SC_FRC_V_FRONT_PORCH_LSB _at_ 0x851D;
xdata UCHAR volatile SC_FRC_H_FRONT_PORCH_LSB _at_ 0x851E;
xdata UCHAR volatile SC_FRC_VH_FRONT_PORCH_MSB _at_ 0x851F;
xdata UCHAR volatile SC_FRC_OUTPUT_VS_WIDTH_LO _at_ 0x8520;
...
xdata UCHAR volatile SC_BUF_LESS_MODE _at_ 0x85FC;
xdata UCHAR volatile SC_MCU_CLK_INV_APR2 _at_ 0x85FD;
xdata UCHAR volatile SC_HDCP_PROG_SEL _at_ 0x8600;
...
xdata UCHAR volatile SC_TVIR_ENABLE _at_ 0x8900;
xdata UCHAR volatile SC_TVIR_SELECT _at_ 0x8901;
xdata UCHAR volatile SC_TVIR_POLARITY _at_ 0x8902;
xdata UCHAR volatile SC_TVIR_PORT1_DELAY_LO _at_ 0x8903;
xdata UCHAR volatile SC_TVIR_PORT1_DELAY_MI _at_ 0x8904;
xdata UCHAR volatile SC_TVIR_PORT1_DELAY_HI _at_ 0x8905;
xdata UCHAR volatile SC_TVIR_PORT2_DELAY_LO _at_ 0x8906;
xdata UCHAR volatile SC_TVIR_PORT2_DELAY_MI _at_ 0x8907;
xdata UCHAR volatile SC_TVIR_PORT2_DELAY_HI _at_ 0x8908;
xdata UCHAR volatile SC_TVIR_PORT3_DELAY_LO _at_ 0x8909;
xdata UCHAR volatile SC_TVIR_PORT3_DELAY_MI _at_ 0x890A;
xdata UCHAR volatile SC_TVIR_PORT3_DELAY_HI _at_ 0x890B;
xdata UCHAR volatile SC_TVIR_DUTY_LO _at_ 0x890C;
xdata UCHAR volatile SC_TVIR_DUTY_MI _at_ 0x890D;
xdata UCHAR volatile SC_TVIR_DUTY_HI _at_ 0x890E;
...
xdata UCHAR volatile SC_SCALER_3D_DEBUG2 _at_ 0x8AF1;
...
xdata UCHAR volatile SC_ADC_PERF_OPT1 _at_ 0x8C77;
xdata UCHAR volatile SC_ADC_PERF_OPT2 _at_ 0x8C78;
xdata UCHAR volatile SC_ADC_PERF_OPT3 _at_ 0x8C79;
xdata UCHAR volatile SC_ADC_PERF_OPT4 _at_ 0x8C7A;
...
xdata UCHAR volatile SC_OSD_3D_FORMAT _at_ 0x8D3F;
xdata UCHAR volatile SC_OSD_DEPTS_L_DEPTS_OUTPUT _at_ 0x8D40;

xdata UCHAR volatile SC_OSD_REF_F_PPOCH_LO _at_ 0x8D41;
xdata UCHAR volatile SC_OSD_REF_F_PPOCH_HI _at_ 0x8D42;

xdata UCHAR volatile SC_DDR_CMD_PLEG _at_ 0x8E00;
xdata UCHAR volatile SC_DDR_CMD_NLEG _at_ 0x8E01;
xdata UCHAR volatile SC_DDR_PHY_MCK_WR_EN _at_ 0x8E05;
xdata UCHAR volatile SC_RD_DQS_WND_ADJ _at_ 0x8E07;
xdata UCHAR volatile SC_DDR_PHY_APLL_CTRL _at_ 0x8E08;
xdata UCHAR volatile SC_DDR_PHY_E20 _at_ 0x8E20;
xdata UCHAR volatile SC_DDR_PHY_E22 _at_ 0x8E22;
xdata UCHAR volatile SC_DDR_PHY_CTRL_LO _at_ 0x8E2D;
xdata UCHAR volatile SC_DDR_PAD_CTRL_LO _at_ 0x8E2E;
xdata UCHAR volatile SC_ODT_MODE_CTRL_LO _at_ 0x8E2F;
xdata UCHAR volatile SC_WR_DQ_PHASE_LO _at_ 0x8E3B;
xdata UCHAR volatile SC_WR_DQS_PHASE_LO _at_ 0x8E3C;
xdata UCHAR volatile SC_WR_CMD_PHASE _at_ 0x8E3D;
xdata UCHAR volatile SC_WR_CLK_PHASE _at_ 0x8E3E;
xdata UCHAR volatile SC_RD_DQS_PHASE_LO _at_ 0x8E3F;
xdata UCHAR volatile SC_DDR_PHY_CTRL_HI _at_ 0x8E5B;
xdata UCHAR volatile SC_DDR_PAD_CTRL_HI _at_ 0x8E5C;
xdata UCHAR volatile SC_ODT_MODE_CTRL_HI _at_ 0x8E5D;
xdata UCHAR volatile SC_WR_DQ_PHASE_HI _at_ 0x8E64;
xdata UCHAR volatile SC_WR_DQS_PHASE_HI _at_ 0x8E65;
xdata UCHAR volatile SC_RD_DQS_PHASE_HI _at_ 0x8E67;

xdata UCHAR volatile SC_2Dto3D_ENABLE_CONTROL _at_ 0x8F00;
