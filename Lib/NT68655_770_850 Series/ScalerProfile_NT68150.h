...
/*                            All Rights Reserved                             */
/******************************************************************************/
#ifndef __SCALER_PROFILE_NT68150_H__
#define __SCALER_PROFILE_NT68150_H__
...
#define SCREG_1EB      0x03//0x02
#define SCREG_1ED      0x09//0x08//(SC_ADC_BAND_GAP|BIT3)

#if ENABLE_LD == ON
#define SCREG_1ED_INIT     0x09//0x08//(SC_ADC_BAND_GAP|BIT3|BIT0)  
#else
#define SCREG_1ED_INIT      0x09//0x08//(SC_ADC_BAND_GAP|BIT3|BIT1|BIT0)
#endif
...
#else
#define LED_DRV_REG_TABLE { \
            0x00,0x0F,0xFF,0x00,0x20,0x30,0xA9,0x69,0x18,0x37,0x3A,0xC0,0x70,0x00,0x00,0x00, \
            0x0F,0x00,0x0D,0x00,0x00,0xFF,0x00,0xCC,0x00,0x80,0x00,0xE5,0x2E,0x0F,0xFF,0xE0,  \
            0x00,0x0B,0x80,0x00,0x00, \
        } // 0xe07 ER=0.3V,e08 comp sink=0.3uA,short mask 16t,
#endif
