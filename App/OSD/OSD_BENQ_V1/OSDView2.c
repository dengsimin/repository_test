...
UCHAR OSDUpdateKeyInfo(BOOL bUpdate,USHRT usOsdState)
{
    ...
    else if (usOsdState>=OSD_MAIN_1_1_STATE&&usOsdState<OSD_ITEM_1_1_STATE)//LAYER_2 OSD
    {
        ...
        else if (usOsdState == (OSD_MAIN_2_END-1)||usOsdState == (OSD_MAIN_4_END-1))//BUTTOM
            ucKeyInfoType = OSDKEYINFO_TYPE_URLE;
        else if (usOsdState == OSD_MAIN_4_10_STATE)
            ucKeyInfoType = OSDKEYINFO_TYPE_UDLE;
       // else if ((usOsdState == OSD_MAIN_1_2_STATE) && ((UserData.ucInputSource != INPUT_SC_VGA)||IsComponentInput())){
    ...
    else if (usOsdState>=OSD_ITEM_1_1_STATE&&usOsdState<OSD_SUBITEM_2_5_4_STATE_BEG)////LAYER_3 OSD
    {
        ...
        if (usOsdState>=OSD_ITEM_1_3_STATE&&usOsdState<=OSD_ITEM_1_6_STATE)
            ...
            ucKeyInfoType = OSDKEYINFO_TYPE_UDLE;
        else if (usOsdState==OSD_ITEM_4_1_1_STATE||usOsdState==OSD_ITEM_4_1_2_STATE||usOsdState == OSD_ITEM_2_5_4_STATE)//ULEric140407
            ucKeyInfoType = OSDKEYINFO_TYPE_UDRLE;
            ...
            ucKeyInfoType = OSDKEYINFO_TYPE_DOLE;
        else if (usOsdState==(OSD_ITEM_4_2_END-1)||usOsdState==(OSD_ITEM_4_3_END-1)||usOsdState==(OSD_ITEM_4_4_END-1)/*||usOsdState==OSD_ITEM_3_1_9_STATE*/)//ULEric140411
            ucKeyInfoType = OSDKEYINFO_TYPE_UOLE;
        ...
        else if  (usOsdState == OSD_ITEM_3_1_6_STATE||usOsdState==OSD_ITEM_3_1_3_STATE) //picture mode : LBL
            ucKeyInfoType = OSDKEYINFO_TYPE_UDRLE;
        else{
            ucKeyInfoType = OSDKEYINFO_TYPE_UDOLE;
        }
    ...
    switch(id)
    {
        case 0://Up
            ...
            //--
                ...
                if((UserData.bSmartReminder == OFF)&&(!(isOSDAllowEyeProtect()))&&(!(isOSDAllowEyeProtectMeter()))){
                    Result = TRUE;
                }
            }
        ...
        case 1://Down
            ...
            //--
            else if((usStatus == (OSD_ITEM_4_2_END-1))&&!Clr)
                Result = TRUE;
            else if((usStatus == (OSD_ITEM_4_3_END-1))&&!Clr)
                Result = TRUE;
            else if((usStatus == (OSD_ITEM_4_4_END-1))&&!Clr)
                Result = TRUE;        
            break;
...
void OSDShowTitleString(void)
{
    ...
    ShowIndentString(TRUE, OSD_TITLESTR_OFFSET_X+OSD_POSITION_OFFSET, 1, 22, ModeTitleTab[UserData.ucBFMode*NUM_OSDLANGS + UserData.ucLanguage]);    
}
                ...
                case OSD_MAIN_PICTURE_ADVANCED:
                    switch (id) {
                        ...
                        //printf("ucBFMode = %02BX\r\n",UserData.ucBFMode);
                            ...
                            break;
                        #else
                        //printf("Picture mode : OSD_preview_temp %bx\r\n",Custom_System.ucOSD_preview_temp);
...
void OSDClrLayer1Menu(UCHAR id)
{
    ...
    OSDAPI_FillLineAttr(ucLayer1StringInfoTb[0]-4, ucLayer1StringInfoTb[1]+id*LAYER_STR_OFFSET_Y-1, LAYER1_LENGTH, UnSelectedStringColor);
    OSDAPI_FillLineAttr(ucLayer1StringInfoTb[0]-4, ucLayer1StringInfoTb[1]+id*LAYER_STR_OFFSET_Y+1, LAYER1_LENGTH, UnSelectedStringColor);

    // redraw layer1 string color
    for (i=0; i<MAINMENU_ICON_NUM; i++) {
        if (i == id) {
            OSDAPI_FillLineAttr(ucLayer1StringInfoTb[0], ucLayer1StringInfoTb[1]+i*LAYER_STR_OFFSET_Y, LAYER1_LENGTH-4, SelectedStringColor1);    
        }
        else {
            if(i == MainIcon_ECO){
                if(UserData.bOSDRotation == TRUE)
            ...
            OSDAPI_FillLineAttr(ucLayer1StringInfoTb[0], ucLayer1StringInfoTb[1]+i*LAYER_STR_OFFSET_Y, LAYER1_LENGTH-4, attr);
        }
    }
    ...
    for (i=0; i<MAINMENU_ICON_NUM; i++) {
        if (i == id) {
            OSDAPI_FillLineAttr(ucMainIconPos[i*2], ucMainIconPos[i*2+1], 3, SelectedStringColor1);
            OSDAPI_FillLineAttr(ucMainIconPos[i*2], ucMainIconPos[i*2+1]+1, 3, SelectedStringColor1);
        }
        else {
            if(i == MainIcon_ECO){
                if(UserData.bOSDRotation == TRUE)
            ...
            OSDAPI_FillLineAttr(ucMainIconPos[i*2], ucMainIconPos[i*2+1], 3, attr);
            OSDAPI_FillLineAttr(ucMainIconPos[i*2], ucMainIconPos[i*2+1]+1, 3, attr);
        }
    }
...
void OSDShowMainMenuIcon(UCHAR id)
{
    ...
    switch (id) {
        case MainIcon_Display:
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1], 3, ucIcon_Display_IndexTab1);
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1]+1, 3, ucIcon_Display_IndexTab2);
            break;
        case MainIcon_Picture:
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1], 3, ucIcon_Picture_IndexTab1);
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1]+1, 3, ucIcon_Picture_IndexTab2);
            break;
        case MainIcon_PictureAdvance:
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1], 3, ucIcon_PictureAd_IndexTab1);
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1]+1, 3, ucIcon_PictureAd_IndexTab2);
            break;
        case MainIcon_Audio:
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1], 3, ucIcon_Audio_IndexTab1);
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1]+1, 3, ucIcon_Audio_IndexTab2);
            break;
        case MainIcon_System:
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1], 3, ucIcon_System_IndexTab1);
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1]+1, 3, ucIcon_System_IndexTab2);
            break;
        case MainIcon_Ergonomics:
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1], 3, ucIcon_Ergonomics_IndexTab1);
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1]+1, 3, ucIcon_Ergonomics_IndexTab2);
            break;
        case MainIcon_ECO:
            #if 1
            ...
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1], 3, ucIcon_ECO_IndexTab1);
            OSDAPI_WriteXYString(TRUE, ucMainIconPos[id*2], ucMainIconPos[id*2+1]+1, 3, ucIcon_ECO_IndexTab2);
            break;
    }
}
...
void OSDFocusMain(UCHAR id)
{
    ...
    for (i=0; i<MAINMENU_ICON_NUM; i++) {
        ...
        OSDAPI_FillLineAttr(ucLayer1StringInfoTb[0], ucLayer1StringInfoTb[1]+i*3, LAYER1_LENGTH-4, attr);
    }
...
void OSDUnselectLayer1Item(UCHAR id, BOOL isUp)
{
    ...
    // icon part
    OSDAPI_FillLineAttr(ucMainIconPos[id*2], ucMainIconPos[id*2+1], 3, MAINICON_1BIT_COLOR1);
...
void OSDSelectLayer1Icon(UCHAR id)
{
    ...
    // icon part
    OSDAPI_FillLineAttr(ucMainIconPos[id*2], ucMainIconPos[id*2+1], 3, SelectedStringColor);
...
void OSDExitItms(UCHAR itm)
{
    ...
    if(isOSDClearLayer4(itm)){
        ClrLayer4();          
        if(ucMenuType == OSD_MAIN_PICTURE_ADVANCED && ucSubMenuType == OSD_PICTURE_AD_PIC && itm == PICTURE_MODE_ANIMATION){
            OSDAPI_OSDWinOff(OSD_WINDOW2);
        }
    }
#endif
...
//    UCHAR i, j;
    ...
    if(UserData.bOSDRotation == FALSE){//#if SELECT_PAGE_POS == 0
        ...
        OSDPageMainFrame(Offset_x, Offset_y, Iconwidth);
    }	
    else {
        if (Type == FrameWidthType_MainMenu) {
            Offset_x = 0;
...
void OSDBlinkTopPageButton(UCHAR id)
{
    ...
    //BTN_Pos = SELECT_PAGE_POS;
      ...
      BTN_Pos = KEYBTN_POS_RIGHT;
      #else
      if(UserData.bOSDRotation == TRUE){
          BTN_Pos = KEYBTN_POS_LEFT;
      }
      else{
          BTN_Pos = KEYBTN_POS_BOTTOM;
      }
      #endif
    ...
    switch (id) {
        case 0:
    	     OSDAPI_FillLineAttr(id*BTN_Width, 0, BTN_Width, TOPPAGE_2BIT_COLOR1_BLUE);    //BTN_width = 8
    	     OSDAPI_FillLineAttr(id*BTN_Width+BTN_Width, 0, 1, SELECTPAGE_4BIT_COLOR_BLUE_UPPER);
             for (i=1; i<4; i++) {	
		        OSDAPI_FillLineAttr(id*BTN_Width, i, 1, TOPPAGE_2BIT_COLOR1_BLUE); 	
    	        if (BTN_Pos == 0)
        ...
        case 3:
            ...
            break;
        case 4:
	        OSDAPI_FillLineAttr(id*BTN_Width, 0, 1, SELECTPAGE_4BIT_COLOR_BLUE_LOWER);	
            OSDAPI_FillLineAttr(id*BTN_Width+1, 0, BTN_Width, TOPPAGE_2BIT_COLOR1_BLUE);    //BTN_width = 8
            for (i=1; i<4; i++) {
		        OSDAPI_FillLineAttr(id*BTN_Width, i, 1, SELECTPAGE_2BIT_COLOR5); 
		        if (BTN_Pos == 0)
		  	        OSDAPI_FillLineAttr(id*BTN_Width+1, i, BTN_Width-1, TOPPAGE_1BIT_COLOR1_BLUE);
		  	        ...
		  	        OSDAPI_FillLineAttr(id*BTN_Width+1, i, BTN_Width-1, TOPPAGE_1BIT_COLOR1_BLUE_B1);
                OSDAPI_FillLineAttr(id*BTN_Width+BTN_Width, i, 1, TOPPAGE_2BIT_COLOR1_BLUE);
            }
            break;
    }
    Sleep(100);
...
void OSDPageMainFrame(UCHAR Offsetx, UCHAR Offsety, UCHAR Width)
{
    ...
    // From Second to Fifth Icon Top Repeat
    for(i=1; i<5; i++){
	for(j=1; j<Width; j++)
		OSDAPI_WriteXYChar(TRUE, Offsetx+i*Width+j, Offsety, SP_TopRepeat);
    }
    OSDAPI_WriteXYChar(TRUE, Offsetx+5*Width,Offsety, SP_Bot_RightTopCorner); 

    //Right Side Repeat
    for(j=1; j<4; j++)
		OSDAPI_WriteXYChar(TRUE, Offsetx+5*Width, Offsety+j, SP_Bot_RightSideRepeat);
...
UCHAR isCustomMenuSlider(void)
{
    ...
    if((CustomKeyType == CUSTOMER_KEY_VOLUME)||(CustomKeyType == CUSTOMER_KEY_BRIGHTNESS)||(CustomKeyType == CUSTOMER_KEY_CONTRAST)||(CustomKeyType == CUSTOMER_KEY_ANIMATION_MODE)){
        return TRUE;
    }
    else{
        return FALSE;
