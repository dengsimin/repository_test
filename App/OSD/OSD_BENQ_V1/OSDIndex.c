...
code UCHAR **SecondLevelTabOfMItem4[] = {OSDSettingTab1, CustKeyTabStr1, CustKeyTabStr1, CustKeyTabStr1, 
                                         OnOffTab1,OnOffTab1,OnOffTab1, AutoPowerOffTab1, 
...
code UCHAR ModelWord_Str1[] = {8, Inform_Model_TEXT};
