...
//******************************************************************************
#define OSD_ITEM_LBL_STATE          OSD_ITEM_3_1_6_STATE
...
typedef enum _OSDSTATE_ {
    ...
    OSD_CUSTKEY_PICTUREMODE_1_STATE = OSD_TOPPAGE_END,
#if	ENABLE_CAD_MODE == ON
    OSD_CUSTKEY_PICTUREMODE_2_STATE,
#endif
#if	ENABLE_ANIMATION_MODE == ON
    OSD_CUSTKEY_PICTUREMODE_3_STATE,
#endif
#if	ENABLE_PRESENTATION_MODE == ON
    OSD_CUSTKEY_PICTUREMODE_4_STATE,
#endif
    OSD_CUSTKEY_PICTUREMODE_5_STATE,
    OSD_CUSTKEY_PICTUREMODE_6_STATE,
#if ENABLE_PICTURE_MODE_GAME == ON    
    OSD_CUSTKEY_PICTUREMODE_7_STATE,
#endif    
    OSD_CUSTKEY_PICTUREMODE_8_STATE,
    OSD_CUSTKEY_PICTUREMODE_9_STATE,
    OSD_CUSTKEY_PICTUREMODE_10_STATE,
#if ENABLE_PICTURE_MODE_MBOOK == ON
    OSD_CUSTKEY_PICTUREMODE_11_STATE,
#endif
    OSD_CUSTKEY_PICTUREMODE_12_STATE,
    OSD_CUSTKEY_PICTUREMODE_END,
    OSD_CUSTKEY_INPUT_1_STATE = OSD_CUSTKEY_PICTUREMODE_END,
    ...
    OSD_CUSTKEY_CONTRAST_STATE = OSD_CUSTKEY_ANIMATION_END,
#else
    OSD_CUSTKEY_CONTRAST_STATE = OSD_CUSTKEY_LOWBULELIGHTMODE_END,
#endif    
    ...
    OSD_ITEM_PIVOT_END,
    OSD_ITEM_1_2_1_STATE = OSD_ITEM_PIVOT_END,
#else
    OSD_ITEM_1_2_1_STATE = OSD_ITEM_1_1_END,
#endif
    ...
    OSD_ITEM_3_1_1_STATE = OSD_ITEM_2_9_END,    //sRGB
#if	ENABLE_CAD_MODE == ON
    OSD_ITEM_3_1_2_STATE,                       //CAD
#endif
#if	ENABLE_ANIMATION_MODE == ON
    OSD_ITEM_3_1_3_STATE,                       //Animation
#endif
#if	ENABLE_PRESENTATION_MODE == ON
    OSD_ITEM_3_1_4_STATE,                       //Presentation
#endif    
    OSD_ITEM_3_1_5_STATE,                       //Standard
    OSD_ITEM_3_1_6_STATE,                       //LBL
#if ENABLE_PICTURE_MODE_GAME == ON    
    OSD_ITEM_3_1_7_STATE,                       //Game
#endif    
    OSD_ITEM_3_1_8_STATE,                       //Movie
    OSD_ITEM_3_1_9_STATE,
    OSD_ITEM_3_1_10_STATE,                      //Photo
#if ENABLE_PICTURE_MODE_MBOOK == ON    
    OSD_ITEM_3_1_11_STATE,                      //Mbook
#endif    
    OSD_ITEM_3_1_12_STATE,
    OSD_ITEM_3_1_END,
    OSD_ITEM_3_2_1_STATE = OSD_ITEM_3_1_END,
    OSD_ITEM_3_2_2_STATE,
    OSD_ITEM_3_2_END,
    ...
    OSD_ITEM_4_2_5_STATE,
    OSD_ITEM_4_2_6_STATE,
    OSD_ITEM_4_2_7_STATE,
    OSD_ITEM_4_2_8_STATE,
    OSD_ITEM_4_2_9_STATE,
    OSD_ITEM_4_2_10_STATE,
    OSD_ITEM_4_2_11_STATE,
    OSD_ITEM_4_2_12_STATE,    
    OSD_ITEM_4_2_13_STATE,
    OSD_ITEM_4_2_14_STATE,    
    OSD_ITEM_4_2_15_STATE,
    OSD_ITEM_4_2_16_STATE,    
    OSD_ITEM_4_2_END,
...
#else
    // Color temperature
    OSD_SUBITEM_2_5_4_STATE_BEG = OSD_ITEM_ERGO_END,
#endif
    ...
    OSD_SUBITEM_4_1_1_BEG = OSD_SUBITEM_3_1_3_END,
#else    
    // Multi-Language
    OSD_SUBITEM_4_1_1_BEG = OSD_SUBITEM_3_1_2_END,
#endif    
