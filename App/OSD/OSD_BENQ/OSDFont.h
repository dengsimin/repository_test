...
#define BENQ_GRAY_9       0xCE59    // R200 G200 B200
...
{
    SP_ICON_1Bit_Start = MainIconOneBit_End,//61
...
enum TopPageIcon_OneBit
{
    ...
    TP_1Bit_Input_End = TP_1Bit_Input_Start+12,

    // Brightness icon
    TP_1Bit_Brightness_Start = TP_1Bit_Input_End,
    TP_1Bit_Brightness_End= TP_1Bit_Brightness_Start+7,

    // Auto Adjustment icon
    TP_1Bit_Auto_Start = TP_1Bit_Brightness_End,
    TP_1Bit_Auto_End = TP_1Bit_Auto_Start+12,

    // Menu icon
    TP_1Bit_Menu_Start = TP_1Bit_Auto_End,
    TP_1Bit_Menu_End = TP_1Bit_Menu_Start+12,

    // Exit icon
    TP_1Bit_Exit_Start = TP_1Bit_Menu_End,
    TP_1Bit_Exit_End = TP_1Bit_Exit_Start+8,

    // DisplayMode icon
    TP_1Bit_DisplayMode_Start = TP_1Bit_Exit_End,
    TP_1Bit_DisplayMode_End = TP_1Bit_DisplayMode_Start+12,

    // Contrast icon
    TP_1Bit_Contrast_Start = TP_1Bit_DisplayMode_End,
    TP_1Bit_Contrast_End = TP_1Bit_Contrast_Start+7,

    // Picture icon
    TP_1Bit_Picture_Start = TP_1Bit_Contrast_End,
    TP_1Bit_Picture_End = TP_1Bit_Picture_Start+8,
...
#define INDENT_STRING_MAX_LEN    (13)
...
enum StringIndex
{
String_Layer1_Index = SP_ICON_End,
...
String_Layer3_Index = OneBitFont_256_end,
String_Layer4_Index = String_Layer3_Index + LAYER3_INDENT_STRING_LEN,
String_TopPage_Index = TP_1Bit_End,
String_DialogString_Index = OneBitFont_256_end,
...
extern void InitFont_Europe();
extern void InitFont_Portugus();
extern void InitFont_Svenska();
extern void InitFont_Pyccknn();
extern void InitFont_Romana();
extern void InitFont_SiCG();
extern void InitFont_Magyar();
extern void InitFont_Cesky();
extern void InitFont_Polski();
extern void InitFont_Espanol();
extern void InitFont_Italiano();
extern void InitFont_Deutsch();
extern void InitFont_Franais();
extern void InitFont_SC_Table1();
extern void InitFont_SC_Table2();
extern void InitFont_TC_Table1();
extern void InitFont_TC_Table2();
extern void InitFont_Japan_Table1();
extern void InitFont_Japan_Table2();
