...
extern void OSDShowLowBlueLightStrings(UCHAR id);
...
extern void OSDUpdateKeyInfo(USHRT usOsdState);//ULEric140328
...
extern void OSDShowHook(UCHAR id, UCHAR CustomerKey);//ULEric140411
