...
code void (*OSDKeyRoutine[OSD_NON_STATE][OSD_NONKEY_EVENT])(void) = {
      ...
      {OSDEnterMenuKeyMenu, OSDEnterTopPageMenu,    OSDEnterTopPageMenu,    /*OSDEnterTopPageMenu*/OSDEnterExitKeyMenu,    /**/NULL},       //OSD_OFF_STATE,
      ...
      {OSDExitCustomerMenu, OSDConfirmCustomerMenu, OSDCustomerMenuUp,      OSDCustomerMenuDown,    OSDItm31ExitTopPageMenu},   //OSD_CUSTKEY_PICTUREMODE_13_STATE
#endif      
      {OSDExitCustomerMenu, OSDConfirmCustomerMenu, OSDCustomerMenuUp,      OSDCustomerMenuDown,    OSDItm31ExitTopPageMenu},   //OSD_CUSTKEY_PICTUREMODE_14_STATE      
     // {NULL, NULL, NULL,      NULL,    NULL},   //OSD_CUSTKEY_PICTUREMODE_END
      ...
      {OSDExitCustomerMenu, OSDConfirmCustomerMenu, OSDCustomerMenuUp,      OSDCustomerMenuDown,    OSDExitTopPageMenu},        //OSD_CUSTKEY_INPUT_5_STATE
#endif
      ...
      {OSDExitSubMenu1,     OSDEnterItm1Pivot,      OSDSubMenuUp1,          OSDSubMenuDown1,        OSDExitTopPageMenu},        //OSD_MAIN_1_POVIT_STATE,
    #endif
...
#endif
#if MD_INPUT_INTERFACE&INPUT_DIG1//#if MD_INPUT_INTERFACE&INPUT_DIG0
...
#endif
#if MD_INPUT_INTERFACE&INPUT_DP1
      {OSDExitItm12,        OSDSelectInput,         OSDItm12Up,             OSDItm12Down,           OSDExitTopPageMenu},        //OSD_ITEM_1_2_5_STATE,
#endif
#else
...
#endif
      {OSDExitItm31,       OSDCheckItm31, OSDItm31Up,             OSDItm31Down,           OSDItm31ExitTopPageMenu},   //OSD_ITEM_3_1_3_STATE,
#if	ENABLE_PICTURE_MODE_CAD == ON
      {OSDExitItm31,        OSDCheckItm31,          OSDItm31Up,             OSDItm31Down,           OSDItm31ExitTopPageMenu},   //OSD_ITEM_3_1_4_STATE,
#endif
#if ENABLE_PICTURE_MODE_ANIMATION == ON
      {OSDExitItm31,        OSDEnterSubItmAnimation,          OSDItm31Up,             OSDItm31Down,           OSDItm31ExitTopPageMenu},   //OSD_ITEM_3_1_5_STATE,
#endif
#if	ENABLE_PRESENTATION_MODE == ON            
      {OSDExitItm31,        OSDCheckItm31,          OSDItm31Up,             OSDItm31Down,           OSDItm31ExitTopPageMenu},   //OSD_ITEM_3_1_6_STATE,      
#endif      
      {OSDExitItm31,        OSDEnterSubItmLBL,      OSDItm31Up,             OSDItm31Down,           OSDItm31ExitTopPageMenu},   //OSD_ITEM_3_1_7_STATE, //origin 313
#if ENABLE_PICTURE_MODE_MOVIE== ON          
...
#if ENABLE_PICTURE_MODE_MBOOK == ON        
      {OSDExitItm31,        OSDCheckItm31,          OSDItm31Up,             OSDItm31Down,           OSDItm31ExitTopPageMenu},   //OSD_ITEM_3_1_13_STATE,
#endif      
      {OSDExitItm31,        OSDCheckItm31,          OSDItm31Up,             OSDItm31Down,           OSDItm31ExitTopPageMenu},   //OSD_ITEM_3_1_14_STATE,
      {OSDExitItm32,        OSDConfirmItm32,        OSDItm32Up,             OSDItm32Down,           OSDItm32ExitTopPageMenu},   //OSD_ITEM_3_2_1_STATE,
      {OSDExitItm32,        OSDConfirmItm32,        OSDItm32Up,             OSDItm32Down,           OSDItm32ExitTopPageMenu},   //OSD_ITEM_3_2_3_STATE,
#if	ENABLE_PICTURE_MODE_CAD == ON
      {OSDExitItm32,        OSDConfirmItm32,        OSDItm32Up,             OSDItm32Down,           OSDItm32ExitTopPageMenu},   //OSD_ITEM_3_2_4_STATE,
#endif
#if	ENABLE_PICTURE_MODE_ANIMATION == ON
      {OSDExitItm32,        OSDConfirmItm32,        OSDItm32Up,             OSDItm32Down,           OSDItm32ExitTopPageMenu},   //OSD_ITEM_3_2_5_STATE,
#endif
      {OSDExitItm32,        OSDConfirmItm32,        OSDItm32Up,             OSDItm32Down,           OSDItm32ExitTopPageMenu},   //OSD_ITEM_3_2_6_STATE,
#if	ENABLE_PICTURE_MODE_DARKROOM == ON
      {OSDExitItm32,        OSDConfirmItm32,        OSDItm32Up,             OSDItm32Down,           OSDItm32ExitTopPageMenu},   //OSD_ITEM_3_2_7_STATE,
#endif
      {OSDExitItm32,        OSDConfirmItm32,        OSDItm32Up,             OSDItm32Down,           OSDItm32ExitTopPageMenu},   //OSD_ITEM_3_2_8_STATE,
      ...
      {OSDExitItm37,        OSDConfirmItm37,        OSDItm37Up,             OSDItm37Down,           OSDItm37ExitTopPageMenu},   //OSD_ITEM_3_7_3_STATE
...
#endif
      {OSDExitSubItm321,        OSDConfirmItm321,        OSDSubItm321Up,             OSDSubItm321Down,           OSDSubItm321ExitTopPageMenu},   //OSD_SUBITEM_3_2_1_1_STATE,
      {OSDExitSubItm321,        OSDConfirmItm321,        OSDSubItm321Up,             OSDSubItm321Down,           OSDSubItm321ExitTopPageMenu},   //OSD_SUBITEM_3_2_1_2_STATE,
      ...
      {OSDExitSubItm411,    OSDEnterSubItm411X,     OSDSubItm411Up,         OSDSubItm411Down,       OSDExitTopPageMenu},        //OSD_SUBITEM_4_1_1_18_STATE,
      ...
      {OSDShowSourceMenu,   OSDShowSourceMenu,      OSDShowSourceMenu,      OSDShowSourceMenu,      /*OSDShowSourceMenu*/NULL},         //OSD_INFO_OUTOFLIMIT_STATE,
      {OSDShowSourceMenu,   OSDShowSourceMenu,      OSDShowSourceMenu,      OSDShowSourceMenu,      /*OSDShowSourceMenu*/NULL},         //OSD_INFO_OUTOFRANCE_STATE,
      {OSDShowSourceMenu,   OSDShowSourceMenu,      OSDShowSourceMenu,      OSDShowSourceMenu,      /*OSDShowSourceMenu*/NULL},         //OSD_INFO_NOSYNC_STATE,
      {OSDShowSourceMenu,   OSDShowSourceMenu,      OSDShowSourceMenu,      OSDShowSourceMenu,      /*OSDShowSourceMenu*/NULL},         //OSD_INFO_NOCABLE_STATE,
      ...
      {OSDUNLOCKKeyMenu,    OSDUNLOCKKeyMenu,       OSDUNLOCKKeyMenu,       OSDUNLOCKKeyMenu,       /*OSDUNLOCKKeyMenu*/NULL},          //OSD_INFO_OSDUNLOCKKEY_STATE,      
      {NULL,                NULL,                   NULL,                   NULL,                   NULL},                      //OSD_INFO_NONPRESET_STATE
      {OSDExitSmartReminder,OSDExitSmartReminder,   OSDExitSmartReminder,   OSDExitSmartReminder,   /*OSDExitSmartReminder*/NULL},      //OSD_INFO_SMART_REMINDER_STATE,
      ...
      {OSDEnterMenuKeyMenu, OSDEnterTopPageMenu,    OSDEnterTopPageMenu,    OSDEnterTopPageMenu,    /*OSDEnterExitKeyMenu*/NULL},       //OSD_INFO_SENSEYE_DEMO,
      {NULL,                NULL,                   OSDConfirmDCRInfor,     OSDExitDCRInfor,        NULL},                      //OSD_INFO_DCR_NOTICE_STATE
#if ENABLE_EYE_PROTECT == ON
      {OSDEnterMenuKeyMenu, OSDEnterTopPageMenu,    OSDEnterTopPageMenu,    OSDEnterTopPageMenu,    /*OSDEnterExitKeyMenu*/NULL},       //OSD_INFO_EYE_PROTECT_METER_STATE
#endif
#if ENABLE_ECO_SENSOR == ON
      {OSDEnterMenuKeyMenu, OSDEnterTopPageMenu,    OSDEnterTopPageMenu,    OSDEnterTopPageMenu,    /*OSDEnterExitKeyMenu*/NULL},       //OSD_INFO_ECO_METER_STATE
#endif
      {NULL,                NULL,                   NULL,                   NULL,                   NULL},                      //OSD_INFO_BURNING_STATE,
      {NULL,                NULL,                   NULL,                   NULL,                   NULL},                      //OSD_OPT1_STATE,,
      {NULL,                NULL,                   NULL,                   NULL,                   NULL},                      //OSD_OPT2_STATE,,
      {/*OSDCloseAll,*/OSDExitFac,         OSDEnterFItm,           OSDUpFactory,           OSDDnFactory,           /*OSDExitFItm*/NULL},               //OSD_FACT_STATE,
      {OSDExitFItm,         OSDExitFItm2,           OSDUpFItm,              OSDDnFItm,              /*OSDExitFItm*/NULL},               //OSD_FITM_STATE,
       //For BENQ Service Menu
      {OSDCloseAll,         OSDAdjSMItm,            OSDUpServiceMenu,       OSDDnServiceMenu,       NULL},                      //OSD_SM_STATE,
       //For BENQ Service Menu
      {NULL,        OSDInputDir2,           OSDInputDir3,           OSDInputDir4,           NULL},                      //OSD_DIRSRC_STATE,
};
