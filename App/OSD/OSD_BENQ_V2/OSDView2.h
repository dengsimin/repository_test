...
//******************************************************************************
#define Araboffset1   17 //main icon
#define Araboffset2   5//4  //main string
#define Araboffset3   55//4  //TitleString
...
#define OSDInputDir2     OSDConfirmInputDVI///OSDConfirmInputMiniDP//OSDConfirmInputHDMI
#define OSDInputDir3     OSDConfirmInputDP//OSDConfirmInputHDMI
#define OSDInputDir4     OSDConfirmInputHDMI//OSDConfirmInputDP
...
extern void OSDShowTopPageString(UCHAR id, USHRT index, UCHAR CustomerKey);
...
extern void OSDShowBurning(void);
...
extern void OSDPageMainFrame_Right(UCHAR Offsetx, UCHAR Offsety, UCHAR Width);
...
extern void OSDConfirmInputMiniDP(void);
...
extern UCHAR isOSDLastItem(USHRT CurrIndex, USHRT StartIndex, UCHAR ItemNum);
extern UCHAR isOSDFirstItem(USHRT CurrIndex, USHRT StartIndex, UCHAR ItemNum);
