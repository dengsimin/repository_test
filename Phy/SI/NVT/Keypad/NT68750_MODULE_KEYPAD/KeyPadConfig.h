...
#define ADGRP1_CODE_2       BTN_CODE_6
...
#define KEYCODE_MENU        ADGRP1_CODE_3
#define KEYCODE_AUTO        ADGRP1_CODE_1
#define KEYCODE_INPUT       ADGRP1_CODE_2
#define KEYCODE_FUNC        ADGRP2_CODE_2
#define KEYCODE_UP          ADGRP2_CODE_1
