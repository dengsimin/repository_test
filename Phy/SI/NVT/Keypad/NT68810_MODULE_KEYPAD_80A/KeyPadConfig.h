...
#define KEY_TYP_LEVEL1      0x29//0x24//0x32 //0x16 //0x2d
#define KEY_TYP_LEVEL2      0x59//0x4F//0x6C //0x3f //0x55
...
#define ADGRP1_CODE_1       BTN_CODE_1
#define ADGRP1_CODE_2       BTN_CODE_2
#define ADGRP1_CODE_3       BTN_CODE_3
#define ADGRP2_CODE_1       BTN_CODE_4
#define ADGRP2_CODE_2       BTN_CODE_5
#define ADGRP2_CODE_3       BTN_CODE_6
...
#define KEYCODE_PWR         ADGRP2_CODE_1
#define KEYCODE_MENU        ADGRP2_CODE_2
#define KEYCODE_AUTO        ADGRP1_CODE_2
#define KEYCODE_INPUT       0x00
#define KEYCODE_FUNC        ADGRP1_CODE_1
#define KEYCODE_UP          ADGRP1_CODE_3
#define KEYCODE_DOWN        ADGRP2_CODE_3
#define KEYCODE_LEFT        0x00
#define KEYCODE_RIGHT       0x00
#define KEYCODE_FACT       (KEYCODE_PWR|KEYCODE_FUNC)
