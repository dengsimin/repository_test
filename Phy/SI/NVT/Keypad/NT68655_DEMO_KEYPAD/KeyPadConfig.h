...
#define KEY_TYP_LEVEL1      0x3F
#define KEY_TYP_LEVEL2      0x7F
...
#define ADGRP1_CODE_3       0x00
#define ADGRP2_CODE_1       BTN_CODE_4
#define ADGRP2_CODE_2       BTN_CODE_5
#define ADGRP2_CODE_3       0x00

// Define active IO key
#define IOBTN_CODE_1        BTN_CODE_1
#define IOBTN_CODE_2        BTN_CODE_2
#define IOBTN_CODE_3        BTN_CODE_3
#define IOBTN_CODE_4        BTN_CODE_4
#define IOBTN_CODE_5        BTN_CODE_5
...
#define KEYCODE_MENU        IOBTN_CODE_2 //ADGRP1_CODE_2
#define KEYCODE_AUTO        IOBTN_CODE_5 // ADGRP1_CODE_1
#define KEYCODE_INPUT       0x00
#define KEYCODE_FUNC        0x00
#define KEYCODE_UP          IOBTN_CODE_3//ADGRP2_CODE_1
#define KEYCODE_DOWN        IOBTN_CODE_4 //ADGRP2_CODE_2
#define KEYCODE_LEFT        0x00
#define KEYCODE_RIGHT       0x00
#define KEYCODE_FACT        (IOBTN_CODE_1|ADGRP1_CODE_1)
