...
#define ADGRP2_CODE_1       BTN_CODE_3
#define ADGRP2_CODE_2       BTN_CODE_4
...
#define KEYCODE_MENU        ADGRP2_CODE_1
#define KEYCODE_AUTO        ADGRP2_CODE_2
#define KEYCODE_INPUT       0x00
#define KEYCODE_FUNC        0x00
#define KEYCODE_UP          ADGRP1_CODE_1
#define KEYCODE_DOWN        ADGRP1_CODE_2
