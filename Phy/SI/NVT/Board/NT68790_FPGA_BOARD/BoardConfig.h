...
#define PORT_E_DEFAULT_DIR      BitsToByte( OUT,   IN,   IN,   IN,   IN,  OUT,   IN,  OUT)
...
#define PORT_C_DEFAULT_PP       BitsToByte(HIGH,  LOW, HIGH,  LOW,  LOW,  LOW,  LOW,  LOW)
...
#define PORT_E_DEFAULT_PU       BitsToByte(HIGH,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
