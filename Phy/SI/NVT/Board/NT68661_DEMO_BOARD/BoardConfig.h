...
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,  OUT,   IN,  OUT,   IN,   IN,   IN,  OUT)
...
#define PORT_A_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW)
#define PORT_B_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_C_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
...
#define PORT_A_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW, HIGH,  LOW, HIGH, HIGH, HIGH)
#define PORT_B_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_C_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH, HIGH)
...
#define VOLUME_PWM_POL          LOW
#define VOLUME_PWM_OUTPUT_PIN   PWMC_PIN_81
//Audio mute control
#define AMP_MUTE_PORT           MCU_PORT_NULL
#define AMP_MUTE_BIT            BIT7
...
#define BKL_PWM_OUTPUT_PIN      PWMC_PIN_64
#define PWM_REF_DBC
