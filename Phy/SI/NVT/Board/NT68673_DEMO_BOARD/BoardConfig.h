...
#define PORT_A_DEFAULT_OUT      BitsToByte( LOW, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH,  LOW)
...
#define VOLUME_PWM_OUTPUT_PIN   PWMA_PD0 //(PWMA_PC6,PWMA_PD0,PWMB_PC2,PWMB_PC5,PWMB_PD1)
//Audio mute control
...
#define BKL_PWM_OUTPUT_PIN      PWMB_PC2
