...
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)
...
//LED green control
#define LED_GREEN_PORT          MCU_PORT_B
...
//DIM configuration
#define BKL_PWM_PORT            PWM_NULL
#define BKL_PWM_POL             HIGH
#define BKL_PWM_OUTPUT_PIN      PWMC_PIN_19
