...
#define PORT_A_DEFAULT_OUT      BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW)
#define PORT_B_DEFAULT_OUT      BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH, HIGH, HIGH, HIGH)
#define PORT_C_DEFAULT_OUT      BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_D_DEFAULT_OUT      BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_E_DEFAULT_OUT      BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_3_DEFAULT_OUT      BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)

//Mcu I/O port default direction       bit:   7     6     5     4     3     2     1     0
#define PORT_A_DEFAULT_DIR      BitsToByte( OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT)
#define PORT_B_DEFAULT_DIR      BitsToByte( OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT)
#define PORT_C_DEFAULT_DIR      BitsToByte( OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT)
#define PORT_D_DEFAULT_DIR      BitsToByte( OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT)
#define PORT_E_DEFAULT_DIR      BitsToByte( OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT)

//Mcu I/O port Push-Pull Configuration bit:   7     6     5     4     3     2     1     0
#define PORT_A_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW, HIGH, HIGH,  LOW, HIGH,  LOW)
...
#define PORT_A_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW, HIGH, HIGH,  LOW, HIGH,  LOW)
...
//AC 5V detection
#define POWER_DETEC_ADC         MCU_ADC_0
...
//Each bit indicates one DDC channel,      NONE  NONE  NONE  NONE  DDC3  DDC2  DDC1  DDC0					   //jerry 2011/08/31+
...
#define MCU_IIC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
...
//RA VSYNC control
#define RA_VSYNC_PORT           MCU_PORT_A
#define RA_VSYNC_BIT            BIT3
#define RA_VSYNC_ACTIVE         HIGH
//RA_RGB control
#define RA_RGB_PORT             MCU_PORT_A
#define RA_RGB_BIT              BIT4
#define RA_RGB_ACTIVE           HIGH
//Backlight control
...
#define VOLUME_PWM_OUTPUT_PIN   PWMB_PIN_56
//Audio mute control
...
//DIM configuration
#define BKL_PWM_PORT            PWM_NULL//PWM_A
#define BKL_PWM_POL             HIGH
#define BKL_PWM_OUTPUT_PIN      PWMC_PIN_19//PWMA_PIN_53
...
//FPGA configuration
#define FPGA_SDA_PORT2          MCU_PORT_NULL
#define FPGA_SDA_BIT2           BIT4
#define FPGA_SCL_PORT2          MCU_PORT_NULL
...
#define KEY_GROUP1_ADC          MCU_ADC_NULL//MCU_ADC_0
#define KEY_GROUP2_ADC          MCU_ADC_NULL//MCU_ADC_1
