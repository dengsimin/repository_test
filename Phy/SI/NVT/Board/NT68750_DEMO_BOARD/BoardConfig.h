...
#define PORT_C_DEFAULT_PP       BitsToByte( LOW, HIGH, HIGH, HIGH, HIGH,  LOW,  LOW,  LOW)
...
#define PORT_A_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
...
#define PORT_3_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  HIGH, LOW)
