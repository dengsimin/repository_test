...
#define PORT_C_DEFAULT_OUT      BitsToByte(HIGH,  LOW, HIGH, HIGH,  LOW, HIGH,  LOW, HIGH)
...
#define PORT_A_DEFAULT_DIR      BitsToByte(  IN,   IN,  OUT,  OUT,  OUT,   IN,  OUT,   IN)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,  OUT)
#define PORT_C_DEFAULT_DIR      BitsToByte( OUT,  OUT,  IN,   OUT,  OUT,  OUT,  OUT,  OUT)
#define PORT_D_DEFAULT_DIR      BitsToByte( OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT)
#define PORT_E_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,  OUT,  OUT,  OUT,   IN)
...
#define PORT_C_DEFAULT_PP       BitsToByte( LOW, HIGH, HIGH, HIGH, HIGH,  LOW,  HIGH, LOW)
#define PORT_D_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW, LOW,   LOW,  LOW,  LOW,  LOW)
#define PORT_E_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW)
...
#define PORT_C_DEFAULT_PU       BitsToByte( LOW, HIGH, HIGH, HIGH, HIGH,  LOW,  HIGH, LOW)
#define PORT_D_DEFAULT_PU       BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#define PORT_E_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW)
...
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW, HIGH,  LOW,  LOW, HIGH, HIGH, HIGH,  LOW)
//AC 5V detection
...
//Use internal EDID
#define USE_INTERNAL_EDID       1	//jerry 2011/08/31+
#define VGA_DDC_CHANNEL         0//0xFF // Channel from 0 ~ 3	   //jerry 2011/08/31+
#define DVI_DDC_CHANNEL         1//0xFF // 0xFF means no use			//jerry 2011/08/31+
...
#define VOLUME_PWM_OUTPUT_PIN   PWMD_PIN_51
//Audio mute control
...
/*******************************************************************************
                               LED String Define
*******************************************************************************/
#define PCBA_LEDSTR_PARALLEL    2
#define PCBA_LEDSTR_EN          BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
