...
#define PORT_A_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH,  LOW, HIGH, HIGH)
#define PORT_B_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH,  LOW)
#define PORT_C_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH,  LOW)
#define PORT_D_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#define PORT_E_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH,  LOW)
...
#define PORT_E_DEFAULT_DIR      BitsToByte( OUT,  OUT,   IN,  OUT,   IN,   IN,  OUT,  OUT)

//Mcu I/O port Push-Pull Configuration bit:   7     6     5     4     3     2     1     0
#define PORT_A_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW)
#define PORT_B_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
#define PORT_C_DEFAULT_PP       BitsToByte( LOW, HIGH,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
#define PORT_D_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_E_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW, HIGH,  LOW,  LOW,  LOW, HIGH)
...
#define PORT_C_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, HIGH, HIGH,  LOW)
...
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW,  LOW, HIGH,  LOW, HIGH, HIGH,  LOW,  LOW)
//AC 5V detection
...
#define DVI_DDC_CHANNEL         0xFF//0x01 // 0xFF means no use
#define HDMI_DDC_CHANNEL        0x01
#define DP_DDC_CHANNEL          0xFF
#define DP1_DDC_CHANNEL         0x03
#define MHL_DDC_CHANNEL         0x01
...
#define DIGI0_CABLE_PORT        MCU_PORT_NULL//MCU_PORT_E
...
#define DP1_CABLE_PORT          MCU_PORT_NULL//MCU_PORT_C
#define DP1_CABLE_BIT           BIT1
#define DP1_CABLE_ACTIVE        LOW

#define CABLE_DET_PORT          MCU_ADC_5
#define HDMI_CABLE_LEVE         0x35
#define DP_CABLE_LEVE           0x27
#define BOTH_ON_LEVE            0x1B
#define BOTH_OFF_LEVE           0x7F
...
#define AMP_MUTE_BIT            BIT2
#define AMP_MUTE_ACTIVE         LOW
//Audio power control
#define AMP_PWR_PORT            MCU_PORT_B
#define AMP_PWR_BIT             BIT0
...
#define DIG1_HPD_PORT           MCU_PORT_NULL//MCU_PORT_E
#define DIG1_HPD_BIT            BIT7
#define DIG1_HPD_ACTIVE         HIGH
#define DP_HPD_PORT             MCU_PORT_NULL//MCU_PORT_E
