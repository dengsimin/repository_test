...
#define PORT_E_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH, HIGH)
#else
...
#if MD_ENABLE_AO_DETECT == OFF
#define PORT_E_DEFAULT_DIR      BitsToByte( OUT,  OUT,   IN,  OUT,   IN,   IN,   IN,  OUT)
#else
...
#if MD_ENABLE_AO_DETECT == OFF
#define PORT_E_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW, HIGH,  LOW,  LOW,  LOW,  LOW)
#else
...
#define MHL_DDC_CHANNEL         0x02 // 0x03
...
#else
#define LED_GREEN_PORT          MCU_PORT_NULL//MCU_PORT_E
#endif
...
//DP HPD pin
#define DPHPD1_CTRLPIN          0//1,2. 0 = no use
#define DPHPD2_CTRLPIN          2//1,2. 0 = no use
