...
#define PORT_A_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH,  LOW,  LOW,  LOW)
...
#define PORT_A_DEFAULT_DIR      BitsToByte(  IN,  OUT,   IN,   IN,  OUT,  OUT,  OUT,  OUT)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,  OUT,   IN,   IN)
...
#define PORT_A_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH, HIGH, HIGH, HIGH)
...
#define PORT_A_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH, HIGH, HIGH, HIGH)
...
#define PORT_3_DEFAULT_PU       BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)

//Each bit indicates one ADC channel,      ADC7  ADC6  ADC5  ADC4  ADC3  ADC2  ADC1  ADC0
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH,  LOW, HIGH, HIGH)
//AC 5V detection
...
#define MCU_PWM_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW)<<8 | \
                                BitsToByte( LOW, HIGH,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
...
#define MCU_DDC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
...
//Backlight control
#define BACKLIGHT_PORT          MCU_PORT_B
...
#define VGA_CABLE_PORT          MCU_PORT_3
...
#define BKL_PWM_OUTPUT_PIN      PWMA_PIN_29
...
#define IOBTN_1_PORT            MCU_PORT_3
#define IOBTN_1_BIT             BIT4
...
#define IOBTN_5_PORT            MCU_PORT_C
