...
#define PORT_C_DEFAULT_OUT      BitsToByte(HIGH,  LOW, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH)
...
#define PORT_A_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,  OUT,   IN)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,  OUT)
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,  OUT,   IN,   IN,  OUT,   IN,   IN,   IN)
#define PORT_D_DEFAULT_DIR      BitsToByte(  IN,  OUT,  OUT,  OUT,   IN,  OUT,  OUT,  OUT)
#define PORT_E_DEFAULT_DIR      BitsToByte( OUT,  OUT,  OUT,   IN,   IN,  OUT,   IN,   IN)

//Mcu I/O port Push-Pull Configuration bit:   7     6     5     4     3     2     1     0
#define PORT_A_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH,  LOW, HIGH,  LOW)
#define PORT_B_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
#define PORT_C_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW,  LOW)
#define PORT_D_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW, HIGH,  LOW,  LOW,  LOW,  LOW)
#define PORT_E_DEFAULT_PP       BitsToByte( LOW, HIGH,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
...
#define PORT_A_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW)
...
#define PORT_D_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW, HIGH,  LOW,  LOW,  LOW,  LOW)
#define PORT_E_DEFAULT_PU       BitsToByte( LOW, HIGH,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
...
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW, HIGH,  LOW, HIGH, HIGH, HIGH,  LOW,  LOW)
//AC 5V detection
...
#define DVI_DDC_CHANNEL         0x00 // 0x02 // 0xFF means no use
#define HDMI_DDC_CHANNEL        0x03
#define DP_DDC_CHANNEL          0x02
#define DP1_DDC_CHANNEL         0x01
...
//Panel power control
#define PANEL_POWER_PORT        MCU_PORT_B
...
//Volume control
#define VOLUME_PWM_PORT         PWM_NULL//PWM_D //(PWM_A,PWM_B,PWM_MCU,PRE_AMP)
...
#define DIG2_HPD_PORT           MCU_PORT_D
#define DIG2_HPD_BIT            BIT0
#define DIG2_HPD_ACTIVE         HIGH
#define DIG3_HPD_PORT           MCU_PORT_D
#define DIG3_HPD_BIT            BIT1
#define DIG3_HPD_ACTIVE         HIGH
#define DP_HPD_PORT             MCU_PORT_NULL
#define DP_HPD_BIT              BIT6
#define DP_HPD_ACTIVE           HIGH
#define DP1_HPD_PORT            MCU_PORT_E
...
#endif
//AUX PN switch
#define AUXPN_SWAP_PORT         MCU_PORT_E
#define AUXPN_SWAP_BIT          BIT6
#define AUXPN_SWAP_ACTIVE       LOW  

//BillBoard Enable
#define BILLBOARD_ENABLE_PORT   MCU_PORT_A
#define BILLBOARD_ENABLE_BIT    BIT1
#define BILLBOARD_ENABLE_ACTIVE HIGH
...
#else
#define DIGITAL_INPUT0_HDCP_MUX 1
#define DIGITAL_INPUT1_HDCP_MUX 2
#define DIGITAL_INPUT2_HDCP_MUX 3
#define DIGITAL_INPUT3_HDCP_MUX 4
#endif
...
//LVDS swap
#define LVDS_AB_CD_SWAP         0
/*******************************************************************************
                           Keypad interface setting
*******************************************************************************/
// Specific AD port of AD key
#define KEY_GROUP1_ADC          MCU_ADC_6 // PA2,ADC6
#define KEY_GROUP2_ADC          NULL // PC0,ADC7
...
#define TYPEC_VBUS_ADC         MCU_ADC_2//MCU_ADC_2
#define TYPEC_CC1_ADC          MCU_ADC_3//MCU_ADC_3
#define TYPEC_CC2_ADC          MCU_ADC_4//MCU_ADC_4
/*******************************************************************************
                               LED String Define
*******************************************************************************/
