...
#define PORT_E_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  HIGH,  HIGH)
...
#define VOLUME_PWM_OUTPUT_PIN   PWMD_PIN_43
//Audio mute control
...
//DIM configuration
#define BKL_PWM_PORT            PWM_A // PWM_LEDDRIVER
#define BKL_PWM_POL             HIGH
#define BKL_PWM_OUTPUT_PIN      PWMA_PIN_69 //PWMA_LEDDRIVER
