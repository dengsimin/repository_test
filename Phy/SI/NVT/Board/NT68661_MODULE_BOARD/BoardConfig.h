...
#define PORT_A_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH, HIGH)
...
#define PORT_E_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,  OUT)

//Mcu I/O port Push-Pull Configuration bit:   7     6     5     4     3     2     1     0
#define PORT_A_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW, HIGH,  LOW,  LOW,  LOW,  LOW)
...
#define PORT_A_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW, HIGH,  LOW, HIGH, HIGH,  LOW)
...
#define PORT_E_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
...
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH, HIGH)
//AC 5V detection
...
#define BKL_PWM_OUTPUT_PIN      PWMA_PIN_61
...
#define IOBTN_1_PORT            MCU_PORT_NULL //MCU_PORT_A
