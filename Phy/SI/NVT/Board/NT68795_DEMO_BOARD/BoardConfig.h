...
#define PORT_A_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,  OUT,   IN,   IN,   IN,  OUT)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,  OUT)
#define PORT_C_DEFAULT_DIR      BitsToByte( OUT,   IN,   IN,   IN,   IN,   IN,  OUT,  OUT)
...
#define PORT_E_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
...
#define PORT_C_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
#define PORT_D_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_E_DEFAULT_PU       BitsToByte( LOW,  LOW, HIGH,  LOW,  LOW,  LOW,  LOW, HIGH)
...
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW, HIGH,  LOW, HIGH,  LOW,  LOW)
//AC 5V detection
...
#define MHL_DDC_CHANNEL         0x01//0x03
...
//LED green control
#define LED_GREEN_PORT          MCU_PORT_C//MCU_PORT_A
#define LED_GREEN_BIT           BIT1//BIT4
...
#define IOBTN_1_PORT            MCU_PORT_NULL//MCU_PORT_B
