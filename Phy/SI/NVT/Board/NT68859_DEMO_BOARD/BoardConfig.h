...
#define PORT_A_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH)
#define PORT_B_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#define PORT_C_DEFAULT_OUT      BitsToByte( LOW, HIGH, HIGH, HIGH, HIGH, HIGH,  LOW, HIGH)
...
#define PORT_A_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
#define PORT_B_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_C_DEFAULT_PP       BitsToByte(HIGH, HIGH, HIGH,  LOW,  LOW,  LOW,  LOW,  LOW)
...
#define PORT_A_DEFAULT_PU       BitsToByte(HIGH, HIGH,  LOW,  LOW,  LOW,  LOW, HIGH, HIGH)
#define PORT_B_DEFAULT_PU       BitsToByte(HIGH, HIGH,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_C_DEFAULT_PU       BitsToByte(HIGH,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
...
//DIM configuration
#define BKL_PWM_PORT            PWM_D //PWM_LEDDRIVER
#define BKL_PWM_POL             HIGH
#define BKL_PWM_OUTPUT_PIN      PWMD_PIN_125 //PWMA_LEDDRIVER
