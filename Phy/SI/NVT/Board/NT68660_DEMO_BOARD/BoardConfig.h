...
#define PORT_E_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH,  LOW, HIGH,  LOW)
...
#define PORT_A_DEFAULT_DIR      BitsToByte( OUT,  OUT,   IN,   IN,  OUT,   IN,  OUT,  OUT)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,   IN,  OUT,  OUT,   IN,   IN,  OUT,  OUT)
#define PORT_D_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)
#define PORT_E_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,  OUT,  OUT,   IN,  OUT)
...
#define PORT_C_DEFAULT_PU       BitsToByte(HIGH, HIGH,  LOW,  LOW, HIGH, HIGH,  LOW,  LOW)
...
#define BKL_PWM_OUTPUT_PIN      PWMA_PIN_76
