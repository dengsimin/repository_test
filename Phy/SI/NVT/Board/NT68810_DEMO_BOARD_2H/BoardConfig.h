...
#define PORT_C_DEFAULT_OUT      BitsToByte(HIGH, HIGH, LOW, HIGH, HIGH, HIGH, HIGH,  LOW)
#define PORT_D_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#if 1//MD_ENABLE_AO_DETECT == OFF
#define PORT_E_DEFAULT_OUT      BitsToByte(LOW, LOW, HIGH,  LOW, HIGH, HIGH, HIGH, LOW)
#else
...
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,  OUT,   OUT,   IN,   IN,   IN,   IN,  OUT)
#define PORT_D_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)
#if 1//MD_ENABLE_AO_DETECT == OFF
#define PORT_E_DEFAULT_DIR      BitsToByte( OUT,  OUT,   OUT,  OUT,   IN,   IN,   OUT,  OUT)  
#else
#define PORT_E_DEFAULT_DIR      BitsToByte( OUT,  OUT,   IN,   IN,   IN,   IN,   IN,  OUT)
#endif
...
#define PORT_C_DEFAULT_PP       BitsToByte( LOW, HIGH,  HIGH,  LOW,  LOW,  LOW,  LOW, HIGH)
#define PORT_D_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#if 1//MD_ENABLE_AO_DETECT == OFF
#define PORT_E_DEFAULT_PP       BitsToByte( LOW,  LOW,  HIGH, HIGH,  LOW,  LOW,  LOW,  LOW)
#else
...
#define PORT_C_DEFAULT_PU       BitsToByte( LOW,  LOW,  HIGH,  LOW,  LOW, HIGH, HIGH,  LOW)
#define PORT_D_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
#define PORT_E_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  HIGH,  LOW,  LOW,  LOW)
...
#define MCU_DDC3_EDIDLEN        1 // 0

//Each bit indicates one IIC channel,      NONE  NONE  NONE  NONE  IIC3  IIC2  IIC1  IIC0
#define MCU_IIC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH, HIGH, HIGH, HIGH)
...
#define MCU_DDC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH, HIGH, HIGH, HIGH)

#define VGA_DDC_CHANNEL         0x00 // Channel from 0 ~ 3
#define DVI_DDC_CHANNEL         0x01 // 0xFF means no use
#define HDMI_DDC_CHANNEL        0xFF//0x03
#define DP_DDC_CHANNEL          0xFF//0x03
#define DP1_DDC_CHANNEL         0x03
#define MHL_DDC_CHANNEL         0xFF

//Backlight control
#define BACKLIGHT_PORT          MCU_PORT_E
#define BACKLIGHT_BIT           BIT5
#define BACKLIGHT_ACTIVE        LOW
//LED green control
#define LED_GREEN_PORT          MCU_PORT_3
#define LED_GREEN_BIT           BIT0// BIT4
...
//Panel power control
#define PANEL_POWER_PORT        MCU_PORT_E
...
#define DIGI0_CABLE_PORT        MCU_PORT_A
#define DIGI0_CABLE_BIT         BIT1
...
//DP0 interface cable connection
#define DP_CABLE_PORT           MCU_PORT_E//MCU_PORT_C
#define DP_CABLE_BIT            BIT3
...
#define VOLUME_PWM_OUTPUT_PIN   PWMD_PIN_59
//Audio mute control
#define AMP_MUTE_PORT           MCU_PORT_B
#define AMP_MUTE_BIT            BIT0
...
//DIM configuration
#define BKL_PWM_PORT            PWM_NULL//PWM_B
#define BKL_PWM_POL             HIGH
#define BKL_PWM_OUTPUT_PIN      PWMB_PIN_63//PWMB_PIN_44
...
#define DP_HPD_PORT             MCU_PORT_E//MCU_PORT_E
#define DP_HPD_BIT              BIT7
#define DP_HPD_ACTIVE           HIGH
#define DP1_HPD_PORT            MCU_PORT_E//MCU_PORT_E
...
//DP HPD pin
#define DPHPD1_CTRLPIN          1//1//1,2. 0 = no use
...
#define KEY_GROUP1_ADC          MCU_ADC_NULL  // 2
#define KEY_GROUP2_ADC          MCU_ADC_NULL  //  3

// Specific IO port of IO key
#define IOBTN_1_PORT            MCU_PORT_NULL   // E
#define IOBTN_1_BIT             BIT7     //  4
