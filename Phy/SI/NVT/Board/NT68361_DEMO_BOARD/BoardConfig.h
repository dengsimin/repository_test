...
#define PORT_C_DEFAULT_OUT      BitsToByte(LOW,  HIGH, HIGH,  LOW, HIGH,  LOW,  LOW, HIGH)
...
#define PORT_A_DEFAULT_DIR      BitsToByte(  IN,   IN,  OUT,  OUT,  OUT,  OUT,   IN,   IN)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,  OUT,   IN)
#define PORT_C_DEFAULT_DIR      BitsToByte(  OUT, OUT,   IN,  OUT,  OUT,  OUT,  OUT,   IN)
...
#define PORT_C_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW)
...
#define PORT_C_DEFAULT_PU       BitsToByte(HIGH,  LOW, HIGH,  LOW,  LOW, HIGH,  LOW, HIGH)
#define PORT_D_DEFAULT_PU       BitsToByte(HIGH,  LOW,  LOW,  LOW, HIGH, HIGH, HIGH, HIGH)
...
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW,  LOW, HIGH, HIGH,  LOW,  LOW,  LOW,  LOW)
//AC 5V detection
...
#define NVRAM_WP_PORT           MCU_PORT_A
