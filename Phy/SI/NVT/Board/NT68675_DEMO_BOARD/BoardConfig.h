...
#define PORT_C_DEFAULT_DIR      BitsToByte(OUT,    IN,   IN,  OUT,   IN,   IN,  OUT,   IN)
#define PORT_D_DEFAULT_DIR      BitsToByte( IN,   OUT,  OUT,   IN,  OUT,   IN,   IN,   IN)
#define PORT_E_DEFAULT_DIR      BitsToByte( IN,    IN,   IN,   IN,   IN,   IN,  OUT,  OUT)

//Each bit indicates one ADC channel,      ADC7  ADC6  ADC5  ADC4  ADC3  ADC2  ADC1  ADC0
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW, HIGH, HIGH, HIGH, HIGH,  LOW,  LOW,  LOW)
//AC 5V detection
...
#define MCU_DDC0_EDIDLEN        1 //EDID Length: 0:128 bytes, 1:256 bytes
...
#define VOLUME_PWM_OUTPUT_PIN   PWMB_PC2 //(PWMA_PC6,PWMA_PD0,PWMB_PC2,PWMB_PC5,PWMB_PD1)
//Audio mute control
...
#define BKL_PWM_OUTPUT_PIN      PWMA_PC6
