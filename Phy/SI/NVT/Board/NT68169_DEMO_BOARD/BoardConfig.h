...
#define PORT_A_DEFAULT_OUT      BitsToByte( LOW, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#define PORT_B_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH,  LOW,  LOW)
...
#define PORT_A_DEFAULT_DIR      BitsToByte( OUT,   IN,   IN,   IN,  OUT,  OUT,   IN,   IN)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,  OUT,  OUT)
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,  OUT,   IN)
#define PORT_D_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)
#define PORT_E_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)

//Mcu I/O port Push-Pull Configuration bit:   7     6     5     4     3     2     1     0
#define PORT_A_DEFAULT_PP       BitsToByte(HIGH, HIGH, HIGH,  LOW,  LOW,  LOW, HIGH,  LOW)
#define PORT_B_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH, HIGH)
#define PORT_C_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW)
...
#define PORT_A_DEFAULT_PU       BitsToByte(HIGH, HIGH, HIGH,  LOW,  LOW,  LOW, HIGH,  LOW)
#define PORT_B_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH, HIGH)
#define PORT_C_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW)
...
#define MCU_IIC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
...
//Use internal EDID
#define USE_INTERNAL_EDID       0	//jerry 2011/08/31+
#define VGA_DDC_CHANNEL         0//0xFF // Channel from 0 ~ 3	   //jerry 2011/08/31+
#define DVI_DDC_CHANNEL         0xFF // 0xFF means no use			//jerry 2011/08/31+
#define HDMI_DDC_CHANNEL        0xFF

//Backlight control
#define BACKLIGHT_PORT          MCU_PORT_C//MCU_PORT_A
#define BACKLIGHT_BIT           BIT1//BIT7
...
//FLASH
#define FLASH_WP_PORT           MCU_PORT_B
#define FLASH_WP_BIT            BIT0
#define FLASH_WP_ACTIVE         LOW
//EDID 24C02
#define EDID_WP_PORT            MCU_PORT_3
...
#define BKL_PWM_OUTPUT_PIN      PWMA_PIN_57
//Hotplug configuration
#define DIG0_HPD_PORT           MCU_PORT_NULL
#define DIG0_HPD_BIT            BIT1
