...
#define PORT_C_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH)
#define PORT_D_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#define PORT_E_DEFAULT_OUT      BitsToByte(HIGH, HIGH,  LOW, HIGH, HIGH, HIGH, HIGH, HIGH)
...
#define PORT_C_DEFAULT_DIR      BitsToByte( OUT,   IN,   IN,   IN,  OUT,   IN,  OUT,   IN)
#define PORT_D_DEFAULT_DIR      BitsToByte(  IN,  OUT,  OUT,   IN,   IN,   IN,  OUT,  OUT)
#define PORT_E_DEFAULT_DIR      BitsToByte(  IN,  OUT,  OUT,   IN,   IN,   IN,   IN,   IN)
...
#define DVI_DDC_CHANNEL         0xFF // 0x04 // 0xFF means no use
...
#define DIGI2_CABLE_PORT        MCU_PORT_C
#define DIGI2_CABLE_BIT         BIT2
#define DIGI2_CABLE_ACTIVE      LOW
//Digital interface 3 cable connection
#define DIGI3_CABLE_PORT        MCU_PORT_E
