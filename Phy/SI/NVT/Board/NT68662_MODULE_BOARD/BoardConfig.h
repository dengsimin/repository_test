...
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,   IN,  OUT,   IN,   IN,   IN,   IN,  OUT)
...
#define PORT_C_DEFAULT_PP       BitsToByte( LOW,  LOW, HIGH,  LOW,  LOW,  LOW,  LOW, HIGH)
...
#define PORT_C_DEFAULT_PU       BitsToByte( LOW, HIGH,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)
...
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW, HIGH,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW)
...
#define MCU_DDC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW, HIGH)
...
#define MCU_IIC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW, HIGH)
...
#define DVI_DDC_CHANNEL         3 //0xFF // 0xFF means no use
#define HDMI_DDC_CHANNEL        0xFF //0xFF
...
#define DIGI1_CABLE_PORT        MCU_PORT_A
#define DIGI1_CABLE_BIT         BIT1
...
#else
// Specific AD port of AD key
#define KEY_GROUP1_ADC          MCU_ADC_6
