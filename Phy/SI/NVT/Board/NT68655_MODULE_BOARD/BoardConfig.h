...
#define PORT_C_DEFAULT_OUT      BitsToByte( LOW, HIGH, HIGH, HIGH,  LOW,  LOW, HIGH, HIGH)
#define PORT_D_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#define PORT_E_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH,  LOW)

//Mcu I/O port default direction       bit:   7     6     5     4     3     2     1     0
#define PORT_A_DEFAULT_DIR      BitsToByte( OUT,  OUT,   OUT,   OUT,  OUT,   IN,   IN,   IN)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,  OUT)
#define PORT_C_DEFAULT_DIR      BitsToByte( OUT,  OUT,   IN,   IN,  OUT,  OUT,  OUT,  OUT)
#define PORT_D_DEFAULT_DIR      BitsToByte( OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT,  OUT)
#define PORT_E_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,  OUT,   IN,   IN,  OUT)
...
#define PORT_E_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH, HIGH)
#define PORT_3_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH, HIGH)

//Mcu I/O port Pull-Up Configuration   bit:   7     6     5     4     3     2     1     0
#define PORT_A_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW)
#define PORT_B_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH, HIGH, HIGH, HIGH)
#define PORT_C_DEFAULT_PU       BitsToByte(HIGH, HIGH, HIGH, HIGH,  LOW,  LOW, HIGH,  LOW)
#define PORT_D_DEFAULT_PU       BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#define PORT_E_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, LOW,  HIGH, HIGH)
#define PORT_3_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, LOW,  HIGH, HIGH)

//Each bit indicates one ADC channel,      ADC7  ADC6  ADC5  ADC4  ADC3  ADC2  ADC1  ADC0
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW, LOW,  LOW,  LOW, HIGH, HIGH, LOW,  LOW)
...
#define MCU_IIC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH,  LOW, HIGH, HIGH)
...
//LED green control
#define LED_GREEN_PORT          MCU_PORT_3
#define LED_GREEN_BIT           BIT0
#define LED_GREEN_ACTIVE        LOW
//LED red control
#define LED_RED_PORT            MCU_PORT_3
...
#define VGA_CABLE_PORT          MCU_PORT_C
#define VGA_CABLE_BIT           BIT5
#define VGA_CABLE_ACTIVE        LOW

//Analog interface 0 cable connection
#define ANA0_CABLE_PORT         MCU_PORT_C
#define ANA0_CABLE_BIT          BIT5
#define ANA0_CABLE_ACTIVE       LOW
//Analog interface 1 cable connection
#define ANA1_CABLE_PORT         MCU_PORT_NULL
#define ANA1_CABLE_BIT          BIT0
#define ANA1_CABLE_ACTIVE       LOW

//Digital interface 0 cable connection
#define DIGI0_CABLE_PORT        MCU_PORT_C
...
//Audio AMP control
#define AUDIOAMP_PORT           MCU_PORT_D
#define AUDIOAMP_BIT            BIT5
#define AUDIOAMP_ACTIVE         HIGH
//Audio Mute control
#define AUDIOMUTE_PORT          MCU_PORT_B
#define AUDIOMUTE_BIT           BIT1
#define AUDIOMUTE_ACTIVE        LOW
...
#define DIG0_HPD_PORT           MCU_PORT_A
...
//ATTEN PORT for TOUCH KEY
#define TOUCHKEY_ATTEN_PORT     MCU_PORT_NULL
#define TOUCHKEY_ATTEN_BIT      BIT7
#define TOUCHKEY_ATTEN_ACTIVE   LOW
#define KEY_SDA_PORT            MCU_PORT_NULL
#define KEY_SDA_BIT             BIT2 //BIT7
#define KEY_SCL_PORT            MCU_PORT_NULL
#define KEY_SCL_BIT             BIT1 //BIT6

//USB Power Control
#define USB_DEVICE_PORT         MCU_PORT_3
#define USB_DEVICE_BIT          BIT0
#define USB_DEVICE_ACTIVE       HIGH

//E-sensor control
#define E_SENSOR_EN_PORT        MCU_PORT_NULL
#define E_SENSOR_EN_BIT         BIT5
#define E_SENSOR_ACTIVE         LOW

#define E_SENSOR_DET_PORT       MCU_PORT_NULL
#define E_SENSOR_DET_BIT        BIT4
#define E_SENSOR_DETECTED       HIGH

#define E_SENSOR_PWM_PORT       PWM_NULL
#define E_SENSOR_PWM_POL        HIGH
#define E_SENSOR_PWM_OUTPUT_PIN PWMB_PIN_41
//FPGA configuration
...
*******************************************************************************/
#define Cable_DET_LEVEL0        0x1C
#define Cable_DET_LEVEL1        0x28
#define Cable_DET_LEVEL2        0x37
#define Cable_DET_LEVEL3        0x7F


#define Cable_DET_JUDGE_ANA0    condition_null
#define Cable_DET_JUDGE_ANA1    condition_null
#define Cable_DET_JUDGE_DIGI0   condition_2
#define Cable_DET_JUDGE_DIGI1   condition_1
