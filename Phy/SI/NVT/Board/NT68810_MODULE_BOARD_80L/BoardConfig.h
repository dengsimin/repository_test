...
#if MD_ENABLE_AO_DETECT == OFF
#define PORT_E_DEFAULT_DIR      BitsToByte( OUT,  OUT,   IN,  OUT,   IN,   IN,   IN,   IN)
#else
#define PORT_E_DEFAULT_DIR      BitsToByte( OUT,  OUT,   IN,   IN,   IN,   IN,   IN,   IN)
#endif
...
#define PORT_B_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW)
...
#define MHL_DDC_CHANNEL         0xFF // 0x03
...
#define DIGI1_CABLE_PORT        MCU_PORT_NULL//MCU_PORT_C
...
#define DP1_CABLE_BIT           BIT2//BIT1
