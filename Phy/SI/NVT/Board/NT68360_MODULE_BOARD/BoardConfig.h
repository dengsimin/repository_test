...
#define PORT_C_DEFAULT_OUT      BitsToByte(HIGH,  LOW, HIGH,  LOW, HIGH,  LOW, HIGH, HIGH)
#define PORT_D_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#define PORT_E_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH,  LOW, HIGH, HIGH)
...
#define PORT_A_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,  OUT,   IN,   IN,   IN,   IN)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,  OUT,   IN,  OUT,  OUT,  OUT,  OUT,   IN)
#define PORT_D_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,  OUT,   IN,   IN,   IN,   IN)
#define PORT_E_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,  OUT,  OUT,   IN)
...
#define PORT_D_DEFAULT_PP       BitsToByte( LOW,  LOW, HIGH, HIGH,  LOW,  LOW,  LOW,  LOW)
#define PORT_E_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW)
...
#define PORT_A_DEFAULT_PU       BitsToByte(HIGH, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH, HIGH)
#define PORT_B_DEFAULT_PU       BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH)
#define PORT_C_DEFAULT_PU       BitsToByte(HIGH,  LOW, HIGH,  LOW,  LOW,  LOW,  LOW, HIGH)
#define PORT_D_DEFAULT_PU       BitsToByte(HIGH, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH, HIGH)
#define PORT_E_DEFAULT_PU       BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH,  LOW, HIGH, HIGH)
...
#define MCU_ADC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW)
//AC 5V detection
#define POWER_DETEC_ADC         MCU_ADC_1
...
#define MCU_DDC_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW, HIGH,  LOW, HIGH, LOW)
...
#define VGA_DDC_CHANNEL         1 // Channel from 0 ~ 3 
#define DVI_DDC_CHANNEL         0//0xFF // 0xFF means no use
#define HDMI_DDC_CHANNEL        3

//Backlight control
#define BACKLIGHT_PORT          MCU_PORT_E
#define BACKLIGHT_BIT           BIT2
...
//Volume control
#define VOLUME_PWM_PORT         PWM_C //(PWM_A,PWM_B,PWM_MCU,PRE_AMP)
#define VOLUME_PWM_POL          HIGH
#define VOLUME_PWM_OUTPUT_PIN   PWMC_PIN_H17
//Audio mute control
#define AMP_MUTE_PORT           MCU_PORT_D
...
#define BKL_PWM_OUTPUT_PIN      PWMD_PIN_J18
//Hotplug configuration
#define DIG0_HPD_PORT           MCU_PORT_C
#define DIG0_HPD_BIT            BIT3
#define DIG0_HPD_ACTIVE         HIGH
#define DIG1_HPD_PORT           MCU_PORT_A
#define DIG1_HPD_BIT            BIT4
#define DIG1_HPD_ACTIVE         HIGH
//POWER MOS configuration
#define POWER_MOS_PORT          MCU_PORT_E
...
*******************************************************************************/
//HDCP MUX
#define DIGITAL_INPUT0_HDCP_MUX 3
