...
#define PORT_C_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH,  LOW)
...
#define PORT_A_DEFAULT_DIR      BitsToByte(  IN,  OUT,   IN,   IN,  OUT,  OUT,  OUT,   IN)
...
#define PORT_E_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,  OUT,  OUT,   IN,   IN)
...
#define PORT_C_DEFAULT_PP       BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH,  LOW, HIGH)
...
#define PORT_C_DEFAULT_PU       BitsToByte(HIGH,  LOW,  LOW,  LOW, HIGH, HIGH,  LOW,  LOW)
...
#define POWER_MOS_BIT           BIT0
#define POWER_MOS_ACTIVE        LOW
