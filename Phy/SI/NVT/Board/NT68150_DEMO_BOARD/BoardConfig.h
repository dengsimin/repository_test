...
#define PORT_B_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH,  LOW, HIGH, HIGH)
...
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,  OUT,   IN,  OUT)
...
#define PORT_B_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, HIGH,  LOW,  LOW)
...
//LED red control
#define LED_RED_PORT            MCU_PORT_B
...
#define VGA_CONNECT_LEVEL       0x63
#define VGA_DISCONNECT_LEVEL    0x79
#define VGA_DET_LEVEL           (VGA_CONNECT_LEVEL + VGA_DISCONNECT_LEVEL) / 2
#define VGA_DET_ADC             MCU_ADC_0
...
#define VOLUME_PWM_OUTPUT_PIN   PWMD_PIN_66
//Audio mute control
