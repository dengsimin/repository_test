...
#define PORT_C_DEFAULT_PP       BitsToByte(HIGH, HIGH, HIGH, HIGH, HIGH, HIGH,  LOW,  LOW)
...
#define PORT_3_DEFAULT_PP       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  HIGH, LOW)
...
#define PORT_3_DEFAULT_PU       BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW, LOW,  HIGH, LOW)
...
#define VGA_DDC_CHANNEL         0 //0xFF // Channel from 0 ~ 3
#define DVI_DDC_CHANNEL         1 //0xFF // 0xFF means no use
#define HDMI_DDC_CHANNEL        3 //0xFF
...
//LED green control
#define LED_GREEN_PORT          MCU_PORT_3//MCU_PORT_NULL
#define LED_GREEN_BIT           BIT1
#define LED_GREEN_ACTIVE        LOW
//LED red control
#define LED_RED_PORT            MCU_PORT_3//MCU_PORT_NULL
...
#define DIGI0_CABLE_PORT        MCU_PORT_E
#define DIGI0_CABLE_BIT         BIT2
#define DIGI0_CABLE_ACTIVE      LOW
//Digital interface 1 cable connection
#define DIGI1_CABLE_PORT        MCU_PORT_C
...
#define DIGITAL_INPUT0_HDCP_MUX 0
...
#define KEY_GROUP1_ADC          MCU_ADC_NULL // MCU_ADC_2
#define KEY_GROUP2_ADC          MCU_ADC_NULL// MCU_ADC_6
