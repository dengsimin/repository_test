...
#define PORT_C_DEFAULT_OUT      BitsToByte(HIGH, HIGH, HIGH,  LOW, HIGH, HIGH, HIGH, HIGH)
...
#define PORT_A_DEFAULT_DIR      BitsToByte(  IN,   IN,  OUT,   IN,   IN,  OUT,  OUT,  OUT)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,  OUT,   IN,  OUT,  OUT,  OUT)
...
#define MCU_PWM_CON_DEFAULT     BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW)<<8 | \
                                BitsToByte( LOW,  LOW,  LOW,  LOW,  LOW,  LOW,  LOW, HIGH)
...
#define DVI_DDC_CHANNEL         0   // 0xFF means no use
...
#define VGA_CABLE_PORT          MCU_PORT_D
...
#define BKL_PWM_OUTPUT_PIN      PWMAB_PIN_NO_SEL
