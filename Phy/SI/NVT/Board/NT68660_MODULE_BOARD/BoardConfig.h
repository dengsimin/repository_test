...
#define PORT_A_DEFAULT_DIR      BitsToByte( IN,  IN,   IN,   IN,  OUT,   IN,  IN,  OUT)
#define PORT_B_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)
#define PORT_C_DEFAULT_DIR      BitsToByte(  IN,   IN,  IN,  OUT,   IN,   IN,  IN,  IN)
#define PORT_D_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,   IN,   IN,   IN,   IN)
#define PORT_E_DEFAULT_DIR      BitsToByte(  IN,   IN,   IN,   IN,  IN,  OUT,   IN,  IN)
...
#define BKL_PWM_OUTPUT_PIN      PWMC_PIN_33
...
#define IOBTN_2_PORT            MCU_PORT_B
...
#define IOBTN_4_PORT            MCU_PORT_B
