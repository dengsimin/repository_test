...
/*                            All Rights Reserved                             */
/******************************************************************************/
#ifndef __SAM_LTM270HU01_H__
#define __SAM_LTM270HU01_H__
...
//******************************************************************************
#define PANEL_NAME              "SAM_LTM270HU01 V"
#define PANEL_TYPE              (SEC|RES_1920X1080)
...
#define PANEL_FOUR_PORT_SWAP    0 //Port A/B/C/D swap ( pixel swap )
                                  //000 = ABCD ( 0,1,2,3 ) 
                                  //001 = ACBD ( 0,2,1,3 ) 
                                  //010 = DCBA ( 3,2,1,0 ) 
                                  //011 = DBCA ( 3,1,2,0 ) 
...
#define PANEL_MAX_HTOTAL        8192

#define PANEL_MIN_VTOTAL        1125
#define PANEL_TYP_VTOTAL        1125
#define PANEL_MAX_VTOTAL        2047

#define PANEL_HSYNC_WIDTH       8 //((PANEL_MIN_HTOTAL - PANEL_WIDTH) / 3 / 8) * 8
#define PANEL_HSYNC_BACKPORCH   40 //((PANEL_MIN_HTOTAL - PANEL_WIDTH) / 3 / 8) * 8
...
#define PANEL_DISP_HSYNC_POL    1 //0:Active low, 1:Active high
#define PANEL_DISP_VSYNC_POL    1 //0:Active low, 1:Active high
#define PANEL_DISP_DE_POL       1 //0:Active low, 1:Active high

#define PANEL_FRC_OUTPUT_VSYNC  1200 //0.1Hz
